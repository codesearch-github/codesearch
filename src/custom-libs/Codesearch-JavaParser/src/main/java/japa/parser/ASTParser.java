...
final class ASTParser implements ASTParserConstants {
    ...
    final public Expression PrimaryPrefix() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case SUPER:
                ...
                nameExpr.setName(token.image);
                nameExpr.setBeginColumn(token.beginColumn);
                nameExpr.setBeginLine(token.beginLine);
                nameExpr.setEndColumn(token.endColumn);
                nameExpr.setEndLine(token.endLine);
                ...
                ret = hasArgs ? new MethodCallExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret, typeArgs, nameExpr, args) : new FieldAccessExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret, null, nameExpr);
                break;
            case LPAREN:
                jj_consume_token(LPAREN);
                line = token.beginLine;
                ...
                if (jj_2_27(2147483647)) {
                    ...
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        case IDENTIFIER:
                            ...
                            ret = hasArgs ? new MethodCallExpr(line, column, token.endLine, token.endColumn, null, null, nameExpr, args) : new NameExpr(line, column, token.endLine, token.endColumn, nameExpr.getName());
                            break;
                        default:
                            jj_la1[87] = jj_gen;
                            jj_consume_token(-1);
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    ...
                    default:
                        ...
                        if (jj_2_29(2147483647)) {
                            ...
                            jj_consume_token(IDENTIFIER);
                            name.setName(token.image);
                            name.setBeginColumn(token.beginColumn);
                            name.setBeginLine(token.beginLine);
                            name.setEndColumn(token.endColumn);
                            name.setEndLine(token.endLine);
                            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                                case LPAREN:
                                    args = Arguments();
                                    hasArgs = true;
    ...
    /*
     * Classes inside block stametents can only be abstract or final. The
     * semantic must check it.
     */
    ...
    private void jj_add_error_token(int kind, int pos) {
        ...
        if (pos == jj_endpos + 1) {
            ...
            jj_entries_loop:
            for (Object element : jj_expentries) {
