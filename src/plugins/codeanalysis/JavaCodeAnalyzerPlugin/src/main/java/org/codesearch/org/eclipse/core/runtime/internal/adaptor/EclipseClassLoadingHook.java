...
import org.codesearch.org.eclipse.osgi.baseadaptor.loader.*;
import org.codesearch.org.eclipse.osgi.framework.adaptor.BundleProtectionDomain;
...
import org.codesearch.org.eclipse.osgi.internal.baseadaptor.BaseClassLoadingHook;
import org.codesearch.org.eclipse.osgi.internal.baseadaptor.BaseStorageHook;
	...
	private String searchVariants(BaseData bundledata, String path) {
		for (int i = 0; i < LIB_VARIANTS.length; i++) {
			...
			if (libEntry != null) {
				...
				if (org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_HPUX.equals(EclipseEnvironmentInfo.getDefault().getOS())) {
					try {
