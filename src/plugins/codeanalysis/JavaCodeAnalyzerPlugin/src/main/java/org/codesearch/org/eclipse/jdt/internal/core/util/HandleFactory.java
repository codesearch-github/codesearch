...
import org.codesearch.org.eclipse.jdt.internal.core.search.AbstractJavaSearchScope;
...
public class HandleFactory {
		...
		if ((separatorIndex= resourcePath.indexOf(IJavaSearchScope.JAR_FILE_ENTRY_SEPARATOR)) > -1) {
			...
			if (this.lastPkgFragmentRootPath == null
				|| !(resourcePath.startsWith(this.lastPkgFragmentRootPath)
					&& !org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isExcluded(resourcePath.toCharArray(), this.lastPkgFragmentRoot.fullInclusionPatternChars(), this.lastPkgFragmentRoot.fullExclusionPatternChars(), false)
	...
	private PackageFragmentRoot getJarPkgFragmentRoot(String resourcePathString, int jarSeparatorIndex, String jarPathString, IJavaSearchScope scope) {
		...
		if (target instanceof IFile) {
			...
			//  e.g. org.codesearch.org.eclipse.swt.win32/ws/win32/swt.jar
			//        is NOT on the classpath of org.codesearch.org.eclipse.swt.win32
