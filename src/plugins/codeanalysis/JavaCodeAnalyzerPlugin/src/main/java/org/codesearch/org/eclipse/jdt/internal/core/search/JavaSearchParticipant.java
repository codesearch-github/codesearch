...
import org.codesearch.org.eclipse.jdt.internal.core.search.indexing.BinaryIndexer;
import org.codesearch.org.eclipse.jdt.internal.core.search.indexing.SourceIndexer;
...
public class JavaSearchParticipant extends SearchParticipant {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.search.SearchParticipant#beginSearching()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.search.SearchParticipant#doneSearching()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.search.SearchParticipant#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.search.SearchParticipant#getDocument(String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.search.SearchParticipant#indexDocument(SearchDocument)
	 */
	public void indexDocument(SearchDocument document, IPath indexPath) {
		...
		if (org.codesearch.org.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(documentPath)) {
			new SourceIndexer(document).indexDocument();
		} else if (org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(documentPath)) {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.search.SearchParticipant#selectIndexes(org.codesearch.org.eclipse.jdt.core.search.SearchQuery, org.codesearch.org.eclipse.jdt.core.search.SearchContext)
	 */
