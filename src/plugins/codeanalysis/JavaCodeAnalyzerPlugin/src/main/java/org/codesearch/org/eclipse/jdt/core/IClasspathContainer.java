 ...
 * for each referenced container (through the extension point "org.codesearch.org.eclipse.jdt.core.ClasspathContainerInitializer").
 * <p>
 * @see IClasspathEntry
 * @since 2.0
 */
...
public interface IClasspathContainer {
	 ...
	 * registered on the extension point "org.codesearch.org.eclipse.jdt.core.classpathContainerInitializer", which can
