...
package org.codesearch.org.eclipse.osgi.internal.baseadaptor;
...
import java.net.*;
import java.util.*;
import org.codesearch.org.eclipse.core.runtime.adaptor.EclipseStarter;
import org.codesearch.org.eclipse.core.runtime.adaptor.LocationManager;
import org.codesearch.org.eclipse.core.runtime.internal.adaptor.EclipseAdaptorMsg;
import org.codesearch.org.eclipse.osgi.baseadaptor.BaseAdaptor;
import org.codesearch.org.eclipse.osgi.baseadaptor.BaseData;
import org.codesearch.org.eclipse.osgi.baseadaptor.bundlefile.*;
import org.codesearch.org.eclipse.osgi.baseadaptor.hooks.*;
import org.codesearch.org.eclipse.osgi.framework.adaptor.*;
...
import org.codesearch.org.eclipse.osgi.framework.internal.core.*;
...
import org.codesearch.org.eclipse.osgi.framework.util.KeyedHashSet;
import org.codesearch.org.eclipse.osgi.service.datalocation.Location;
import org.codesearch.org.eclipse.osgi.service.resolver.*;
import org.codesearch.org.eclipse.osgi.storagemanager.ManagedOutputStream;
		...
		try {
			...
			try {
				...
				for (int i = 0; i < bundles.length; i++) {
					...
					out.writeLong(id);
					if (id != 0) {
						BundleData data = ((org.codesearch.org.eclipse.osgi.framework.internal.core.AbstractBundle) bundles[i]).getBundleData();
