...
import org.codesearch.org.eclipse.osgi.internal.module.ResolverBundle;
...
public class SurrogateImpl extends CompositeBase implements SurrogateBundle {
	...
	public SurrogateImpl(BundleData bundledata, org.codesearch.org.eclipse.osgi.framework.internal.core.Framework framework) throws BundleException {
		super(bundledata, framework);
		this.composite = (CompositeBundle) FrameworkProperties.getProperties().get(PROP_COMPOSITE);
	}

	protected Framework findCompanionFramework(org.codesearch.org.eclipse.osgi.framework.internal.core.Framework thisFramework, BundleData thisData) {
