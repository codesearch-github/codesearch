...
import org.codesearch.org.eclipse.jdt.internal.core.ReconcileWorkingCopyOperation;
 ...
 * </ul>
 */
public org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit getAST3() throws JavaModelException {
	if (this.operation.astLevel != AST.JLS3 || !this.operation.resolveBindings) {
		...
		return (org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit) parser.createAST(this.operation.progressMonitor);
	}
