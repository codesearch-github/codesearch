...
public class ListViewer extends AbstractListViewer {
     ...
     */
    private org.codesearch.org.eclipse.swt.widgets.List list;
    ...
    public ListViewer(Composite parent, int style) {
        this(new org.codesearch.org.eclipse.swt.widgets.List(parent, style));
    }
     ...
     */
    public ListViewer(org.codesearch.org.eclipse.swt.widgets.List list) {
        this.list = list;
        hookControl(list);
    }
     ...
     */
    public org.codesearch.org.eclipse.swt.widgets.List getList() {
        return list;
    }
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listAdd(java.lang.String, int)
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listSetItem(int, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listGetSelectionIndices()
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listGetItemCount()
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listSetItems(java.lang.String[])
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listRemoveAll()
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listRemove(int)
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listSelectAndShow(int[])
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listDeselectAll()
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listShowSelection()
     */
    ...
    /* (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listGetTopIndex()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#listSetTopIndex(int)
     */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jface.viewers.AbstractListViewer#setSelectionToWidget(java.util.List, boolean)
	 */
