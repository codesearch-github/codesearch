 ...
 *
 * @see SearchEngine#createSearchPattern(org.codesearch.org.eclipse.jdt.core.IJavaElement, int)
 * @see SearchEngine#createSearchPattern(String, int, int, boolean)
 * @deprecated Since 3.0, the class
 * {@link org.codesearch.org.eclipse.jdt.core.search.SearchPattern} replaces this interface.
 */
