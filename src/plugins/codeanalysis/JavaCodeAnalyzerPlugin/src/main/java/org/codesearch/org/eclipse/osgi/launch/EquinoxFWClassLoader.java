...
class EquinoxFWClassLoader extends URLClassLoader {
	...
	private static final String[] DELEGATE_PARENT_FIRST = {"java.", "org.osgi.", "org.codesearch.org.eclipse.osgi.launch.", "org.codesearch.org.eclipse.osgi.service.", "org.codesearch.org.eclipse.osgi.framework.log", "org.codesearch.org.eclipse.osgi.framework.adaptor", "org.codesearch.org.eclipse.osgi.framework.internal.core.ReferenceInputStream"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
