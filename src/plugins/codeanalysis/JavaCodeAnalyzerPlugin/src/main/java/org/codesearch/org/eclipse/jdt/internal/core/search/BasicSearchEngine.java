...
import org.codesearch.org.eclipse.jdt.internal.core.search.indexing.*;
import org.codesearch.org.eclipse.jdt.internal.core.search.matching.*;
...
/**
 * Search basic engine. Public search engine (see {@link org.codesearch.org.eclipse.jdt.core.search.SearchEngine}
			...
			if (copies != null) {
				for (int i = 0; i < copiesLength; i++) {
					...
					if (workingCopy.isConsistent()) {
						...
						org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit unit = (org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) workingCopy;
