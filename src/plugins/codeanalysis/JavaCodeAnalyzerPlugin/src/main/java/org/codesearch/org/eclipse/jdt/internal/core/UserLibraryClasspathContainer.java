...
public class UserLibraryClasspathContainer implements IClasspathContainer {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.IClasspathContainer#getClasspathEntries()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.IClasspathContainer#getDescription()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.IClasspathContainer#getKind()
	 */
	public int getKind() {
		UserLibrary library= getUserLibrary();
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.IClasspathContainer#getPath()
	 */
