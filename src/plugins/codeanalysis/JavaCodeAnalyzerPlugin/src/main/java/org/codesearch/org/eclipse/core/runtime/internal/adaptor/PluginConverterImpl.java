 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.core.runtime.internal.adaptor;

import java.io.*;
import java.util.*;
import java.util.zip.ZipEntry;
import java.util.zip.ZipFile;
import org.codesearch.org.eclipse.core.runtime.adaptor.LocationManager;
import org.codesearch.org.eclipse.osgi.framework.adaptor.FrameworkAdaptor;
import org.codesearch.org.eclipse.osgi.framework.internal.core.Constants;
import org.codesearch.org.eclipse.osgi.framework.internal.core.FrameworkProperties;
import org.codesearch.org.eclipse.osgi.framework.log.FrameworkLogEntry;
import org.codesearch.org.eclipse.osgi.internal.baseadaptor.DevClassPathHelper;
import org.codesearch.org.eclipse.osgi.service.pluginconversion.PluginConversionException;
import org.codesearch.org.eclipse.osgi.service.pluginconversion.PluginConverter;
import org.codesearch.org.eclipse.osgi.service.resolver.VersionRange;
import org.codesearch.org.eclipse.osgi.util.ManifestElement;
...
public class PluginConverterImpl implements PluginConverter {
	...
	private static final String[] ARCH_LIST = {org.codesearch.org.eclipse.osgi.service.environment.Constants.ARCH_PA_RISC, org.codesearch.org.eclipse.osgi.service.environment.Constants.ARCH_PPC, org.codesearch.org.eclipse.osgi.service.environment.Constants.ARCH_SPARC, org.codesearch.org.eclipse.osgi.service.environment.Constants.ARCH_X86, org.codesearch.org.eclipse.osgi.service.environment.Constants.ARCH_AMD64, org.codesearch.org.eclipse.osgi.service.environment.Constants.ARCH_IA64};
	...
	private static final String[] OS_LIST = {org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_AIX, org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_HPUX, org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_LINUX, org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_MACOSX, org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_QNX, org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_SOLARIS, org.codesearch.org.eclipse.osgi.service.environment.Constants.OS_WIN32};
	protected static final String PI_RUNTIME = "org.codesearch.org.eclipse.core.runtime"; //$NON-NLS-1$
	protected static final String PI_BOOT = "org.codesearch.org.eclipse.core.boot"; //$NON-NLS-1$
	protected static final String PI_RUNTIME_COMPATIBILITY = "org.codesearch.org.eclipse.core.runtime.compatibility"; //$NON-NLS-1$
	static public final String PLUGIN_MANIFEST = "plugin.xml"; //$NON-NLS-1$
	private static final String COMPATIBILITY_ACTIVATOR = "org.codesearch.org.eclipse.core.internal.compatibility.PluginActivator"; //$NON-NLS-1$
	private static final String[] WS_LIST = {org.codesearch.org.eclipse.osgi.service.environment.Constants.WS_CARBON, org.codesearch.org.eclipse.osgi.service.environment.Constants.WS_GTK, org.codesearch.org.eclipse.osgi.service.environment.Constants.WS_MOTIF, org.codesearch.org.eclipse.osgi.service.environment.Constants.WS_PHOTON, org.codesearch.org.eclipse.osgi.service.environment.Constants.WS_WIN32};
