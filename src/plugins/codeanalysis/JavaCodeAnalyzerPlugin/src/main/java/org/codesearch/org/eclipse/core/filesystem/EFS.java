...
import org.codesearch.org.eclipse.core.internal.filesystem.InternalFileSystemCore;
...
public class EFS {
	/**
	 * The unique identifier constant (value "<code>org.codesearch.org.eclipse.core.filesystem</code>")
	 * of the Core file system plug-in.
	 */
	public static final String PI_FILE_SYSTEM = "org.codesearch.org.eclipse.core.filesystem"; //$NON-NLS-1$
	 ...
	 * @see IFileInfo#getAttribute(int)
	 * @see IFileInfo#setAttribute(int, boolean)
	 * @since org.codesearch.org.eclipse.core.filesystem 1.3
	 */
