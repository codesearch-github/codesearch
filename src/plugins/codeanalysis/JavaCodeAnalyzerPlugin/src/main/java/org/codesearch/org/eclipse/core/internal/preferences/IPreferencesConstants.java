 ...
 * @since org.codesearch.org.eclipse.equinox.preferences 1.0
 */
public interface IPreferencesConstants {
	/**
	 * Backward compatibilty: name of the original runtime plugin
	 */
	public static final String RUNTIME_NAME = "org.codesearch.org.eclipse.core.runtime"; //$NON-NLS-1$

	/**
	 * Name of this plugin
	 */
	public static final String PREFERS_NAME = "org.codesearch.org.eclipse.equinox.preferences"; //$NON-NLS-1$
