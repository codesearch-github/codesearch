...
public class Browser extends Composite {
	...
	static final String NO_INPUT_METHOD = "org.codesearch.org.eclipse.swt.internal.gtk.noInputMethod"; //$NON-NLS-1$
	static final String PACKAGE_PREFIX = "org.codesearch.org.eclipse.swt.browser."; //$NON-NLS-1$
	static final String PROPERTY_USEWEBKITGTK = "org.codesearch.org.eclipse.swt.browser.UseWebKitGTK"; //$NON-NLS-1$
...
public Browser (Composite parent, int style) {
	...
	if ((style & SWT.MOZILLA) != 0) {
		classNames = new String[] {"org.codesearch.org.eclipse.swt.browser.Mozilla"}; //$NON-NLS-1$
	} else {
		if ("win32".equals (platform) || "wpf".equals (platform)) { //$NON-NLS-1$ $NON-NLS-2$
			classNames = new String[] {"org.codesearch.org.eclipse.swt.browser.IE"}; //$NON-NLS-1$
			...
			if (property != null && property.equalsIgnoreCase ("true")) { //$NON-NLS-1$
				classNames = new String[] {"org.codesearch.org.eclipse.swt.browser.WebKit", "org.codesearch.org.eclipse.swt.browser.Mozilla"}; //$NON-NLS-1$ //$NON-NLS-2$
			} else {
				classNames = new String[] {"org.codesearch.org.eclipse.swt.browser.Mozilla"}; //$NON-NLS-1$
			}
		} else if ("carbon".equals (platform) || "cocoa".equals (platform)) { //$NON-NLS-1$
			classNames = new String[] {"org.codesearch.org.eclipse.swt.browser.Safari"}; //$NON-NLS-1$
		} else if ("photon".equals (platform)) { //$NON-NLS-1$
			classNames = new String[] {"org.codesearch.org.eclipse.swt.browser.Voyager"}; //$NON-NLS-1$
		} else {
			dispose ();
