 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.osgi.util;
...
public abstract class NLS {
	...
	static void log(int severity, String message, Exception e) {
		...
		if (frameworkLog != null) {
			frameworkLog.log(new FrameworkLogEntry("org.codesearch.org.eclipse.osgi", severity, 1, message, 0, e, null)); //$NON-NLS-1$
			return;
		}
		String statusMsg;
		switch (severity) {
