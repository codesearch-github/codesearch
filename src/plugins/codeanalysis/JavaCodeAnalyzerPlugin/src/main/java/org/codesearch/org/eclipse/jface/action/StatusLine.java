...
import org.codesearch.org.eclipse.swt.accessibility.ACC;
import org.codesearch.org.eclipse.swt.accessibility.AccessibleControlAdapter;
import org.codesearch.org.eclipse.swt.accessibility.AccessibleControlEvent;
import org.codesearch.org.eclipse.swt.custom.CLabel;
...
import org.codesearch.org.eclipse.jface.resource.JFaceColors;
...
/* package */class StatusLine extends Composite implements IProgressMonitor {
	...
	static {
		JFaceResources.getImageRegistry().put(
				"org.codesearch.org.eclipse.jface.parts.StatusLine.stopImage", fgStopImage);//$NON-NLS-1$
	}
