...
public class PrefsMessages extends NLS {
	 ...
	 */
	public static final String OWNER_NAME = "org.codesearch.org.eclipse.equinox.preferences"; //$NON-NLS-1$

	private static final String BUNDLE_NAME = "org.codesearch.org.eclipse.core.internal.preferences.messages"; //$NON-NLS-1$
