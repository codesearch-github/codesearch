...
import org.codesearch.org.eclipse.jdt.core.IWorkingCopy;
...
public class BinaryType extends BinaryMember implements IType, SuffixConstants {
	...
	public static final JavadocContents EMPTY_JAVADOC = new JavadocContents(null, org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING);
...
public void codeComplete(char[] snippet,int insertion,int position,char[][] localVariableTypeNames,char[][] localVariableNames,int[] localVariableModifiers,boolean isStatic,ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(snippet, insertion, position, localVariableTypeNames, localVariableNames, localVariableModifiers, isStatic, new org.codesearch.org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
/*
 * @see IType#codeComplete(char[], int, int, char[][], char[][], int[], boolean, ICompletionRequestor)
 */
...
/* (non-Javadoc)
 * @see org.codesearch.org.eclipse.jdt.core.IType#isResolved()
 */
