 ...
 *       (bug 49497 [RCP] JFace dependency on org.codesearch.org.eclipse.core.runtime enlarges standalone JFace applications)
 *******************************************************************************/
...
import org.codesearch.org.eclipse.jface.dialogs.AnimatorFactory;
import org.codesearch.org.eclipse.jface.dialogs.ErrorSupportProvider;
...
public class Policy {
	 ...
	 */
	public static final String JFACE = "org.codesearch.org.eclipse.jface"; //$NON-NLS-1$
	...
	public static void setComparator(Comparator comparator) {
		org.codesearch.org.eclipse.core.runtime.Assert.isTrue(viewerComparator == null);
