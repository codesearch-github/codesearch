 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jdt.internal.core.eval;
...
import org.codesearch.org.eclipse.jdt.core.eval.ICodeSnippetRequestor;
import org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext;
import org.codesearch.org.eclipse.jdt.core.eval.IGlobalVariable;
...
import org.codesearch.org.eclipse.jdt.internal.core.builder.NameEnvironment;
import org.codesearch.org.eclipse.jdt.internal.core.builder.ProblemFactory;
import org.codesearch.org.eclipse.jdt.internal.eval.EvaluationContext;
import org.codesearch.org.eclipse.jdt.internal.eval.GlobalVariable;
import org.codesearch.org.eclipse.jdt.internal.eval.IRequestor;
import org.codesearch.org.eclipse.jdt.internal.eval.InstallException;
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#allVariables()
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor)
 * @deprecated
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor, WorkingCopyOwner)
 * @deprecated
 */
public void codeComplete(String codeSnippet, int position, ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(codeSnippet, position, new org.codesearch.org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor)
 */
public void codeComplete(String codeSnippet, int position, CompletionRequestor requestor) throws JavaModelException {
	codeComplete(codeSnippet, position, requestor, DefaultWorkingCopyOwner.PRIMARY);
}
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, IProgressMonitor)
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner)
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner, IProgressMonitor)
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeSelect(String, int, int)
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#codeSelect(String, int, int, WorkingCopyOwner)
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#deleteVariable(IGlobalVariable)
 */
...
public void evaluateCodeSnippet(
	...
	IProgressMonitor progressMonitor) throws org.codesearch.org.eclipse.jdt.core.JavaModelException {
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#getImports()
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#getPackageName()
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#getProject()
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#newVariable(String, String, String)
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#setImports(String[])
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext#setPackageName(String)
 */
 ...
 */
public void codeComplete(String codeSnippet, int position, final org.codesearch.org.eclipse.jdt.core.ICodeCompletionRequestor requestor) throws JavaModelException {
