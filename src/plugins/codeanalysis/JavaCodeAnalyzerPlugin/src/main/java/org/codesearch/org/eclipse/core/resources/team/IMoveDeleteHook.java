 ...
 * conjunction with the <code>org.codesearch.org.eclipse.core.resources.moveDeleteHook</code>
...
public interface IMoveDeleteHook {
	 ...
	 * @exception OperationCanceledException if the operation is canceled. 
	 * Cancelation can occur even if no progress monitor is provided.
	 * @see IResource#move(org.codesearch.org.eclipse.core.runtime.IPath,int,IProgressMonitor)
	 */
