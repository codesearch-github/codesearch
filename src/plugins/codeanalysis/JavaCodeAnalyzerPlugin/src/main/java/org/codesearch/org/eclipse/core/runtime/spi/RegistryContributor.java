 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.core.runtime.spi;

import org.codesearch.org.eclipse.core.runtime.IContributor;
...
public final class RegistryContributor implements IContributor {
	...
	/**
	 * Actual name of the contributor (e.g., "org.codesearch.org.eclipse.core.runtime.fragment").
	 */
	...
	/**
	 * Name of the entity "in charge" of the contributor (e.g. "org.codesearch.org.eclipse.core.runtime").
	 ...
	 * (e.g., "org.codesearch.org.eclipse.core.runtime.fragment"). The actual name of the contributor must 
	 ...
	 * (e.g., "org.codesearch.org.eclipse.core.runtime"). If contributor does not rely on a host, then
	...
	/**
	 * Provides name of the entity "in charge" of the contributor (e.g., "org.codesearch.org.eclipse.core.runtime").
