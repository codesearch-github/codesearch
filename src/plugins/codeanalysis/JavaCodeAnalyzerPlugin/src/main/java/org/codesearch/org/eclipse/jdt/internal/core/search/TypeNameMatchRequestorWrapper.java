 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jdt.internal.core.search;
 ...
 * 	int typeMatchRule,
 * 	int searchFor,
 * 	org.codesearch.org.eclipse.jdt.core.search.IJavaSearchScope scope,
 * 	IRestrictedAccessTypeRequestor nameRequestor,
 * 	int waitingPolicy,
 * 	org.codesearch.org.eclipse.core.runtime.IProgressMonitor monitor) }.
 * from  API method {@link org.codesearch.org.eclipse.jdt.core.search.SearchEngine#searchAllTypeNames(
 * 	char[] packageName,
 * 	int packageMatchRule,
 * 	char[] typeName,
 * 	int matchRule,
...
/* (non-Javadoc)
 * @see org.codesearch.org.eclipse.jdt.internal.core.search.IRestrictedAccessTypeRequestor#acceptType(int, char[], char[], char[][], java.lang.String, org.codesearch.org.eclipse.jdt.internal.compiler.env.AccessRestriction)
 */
...
private IType createTypeFromPath(String resourcePath, String simpleTypeName, char[][] enclosingTypeNames) throws JavaModelException {
	...
	if (org.codesearch.org.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(simpleName)) {
		...
		return type;
	} else if (org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(simpleName)){
