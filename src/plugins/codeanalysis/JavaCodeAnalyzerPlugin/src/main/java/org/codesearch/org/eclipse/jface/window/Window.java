...
import org.codesearch.org.eclipse.jface.util.Geometry;
...
import org.codesearch.org.eclipse.swt.events.ShellListener;
...
import org.codesearch.org.eclipse.swt.widgets.Monitor;
...
public abstract class Window implements IShellProvider {
	...
	private static class DefaultExceptionHandler implements IExceptionHandler {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.codesearch.org.eclipse.jface.window.Window.IExceptionHandler#handleException(java.lang.Throwable)
		 */
		public void handleException(Throwable t) {
	 ...
	 * 
	 * @see org.codesearch.org.eclipse.swt.widgets.Decorations#setImages(org.codesearch.org.eclipse.swt.graphics.Image[])
	 * 
