...
public class ExtensionsParser extends DefaultHandler {
	...
	private static void initializeExtensionPointMap() {
		...
		map.put("org.codesearch.org.eclipse.ui.markerImageProvider", "org.codesearch.org.eclipse.ui.ide.markerImageProvider"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.markerHelp", "org.codesearch.org.eclipse.ui.ide.markerHelp"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.markerImageProviders", "org.codesearch.org.eclipse.ui.ide.markerImageProviders"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.markerResolution", "org.codesearch.org.eclipse.ui.ide.markerResolution"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.projectNatureImages", "org.codesearch.org.eclipse.ui.ide.projectNatureImages"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.resourceFilters", "org.codesearch.org.eclipse.ui.ide.resourceFilters"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.markerUpdaters", "org.codesearch.org.eclipse.ui.editors.markerUpdaters"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.documentProviders", "org.codesearch.org.eclipse.ui.editors.documentProviders"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.ui.workbench.texteditor.markerAnnotationSpecification", "org.codesearch.org.eclipse.ui.editors.markerAnnotationSpecification"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.help.browser", "org.codesearch.org.eclipse.help.base.browser"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.help.luceneAnalyzer", "org.codesearch.org.eclipse.help.base.luceneAnalyzer"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.help.webapp", "org.codesearch.org.eclipse.help.base.webapp"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("org.codesearch.org.eclipse.help.support", "org.codesearch.org.eclipse.ui.helpSupport"); //$NON-NLS-1$ //$NON-NLS-2$
