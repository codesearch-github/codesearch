...
import org.codesearch.org.eclipse.core.resources.IFileState;
 ...
 * <p>
 * History store policies are stored in the org.codesearch.org.eclipse.core.resources'
 * plug-in preferences.
 * </p>
 * 
 * @since 3.1
...
public interface IHistoryStore extends IManager {
	 ...
	 * the org.codesearch.org.eclipse.core.resource plug-in's preferences and 
