...
public interface EvaluationConstants {
	...
	public static final char[] PACKAGE_NAME = "org.codesearch.org.eclipse.jdt.internal.eval.target".toCharArray(); //$NON-NLS-1$
	public static final char[] CODE_SNIPPET_NAME = "org.codesearch.org.eclipse/jdt/internal/eval/target/CodeSnippet".toCharArray(); //$NON-NLS-1$
