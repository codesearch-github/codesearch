...
import org.codesearch.org.eclipse.osgi.framework.internal.core.FilterImpl;
import org.codesearch.org.eclipse.osgi.framework.util.SecureAction;
import org.codesearch.org.eclipse.osgi.internal.module.GroupingChecker.PackageRoots;
import org.codesearch.org.eclipse.osgi.internal.resolver.BundleDescriptionImpl;
import org.codesearch.org.eclipse.osgi.internal.resolver.ExportPackageDescriptionImpl;
import org.codesearch.org.eclipse.osgi.service.resolver.*;
import org.codesearch.org.eclipse.osgi.util.ManifestElement;
import org.osgi.framework.*;

public class ResolverImpl implements org.codesearch.org.eclipse.osgi.service.resolver.Resolver {
	// Debug fields
	...
	public synchronized void resolve(BundleDescription[] reRefresh, Dictionary[] platformProperties) {
		...
		developmentMode = platformProperties.length == 0 ? false : org.codesearch.org.eclipse.osgi.framework.internal.core.Constants.DEVELOPMENT_MODE.equals(platformProperties[0].get(org.codesearch.org.eclipse.osgi.framework.internal.core.Constants.OSGI_RESOLVER_MODE));
			...
			for (int j = 0; j < imports.length; j++) {
				if (imports[j].getNumPossibleSuppliers() > 1) {
					...
					if (eeProfile.intValue() < 0) {
						...
						// this is an optimization for bundles like org.codesearch.org.eclipse.xerces
