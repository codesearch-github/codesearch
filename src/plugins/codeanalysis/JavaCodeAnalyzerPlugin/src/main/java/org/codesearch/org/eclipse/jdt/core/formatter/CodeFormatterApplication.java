...
import org.codesearch.org.eclipse.equinox.app.IApplication;
...
/**
 * Implements an Eclipse Application for org.codesearch.org.eclipse.jdt.core.JavaCodeFormatter.
 *
...
public class CodeFormatterApplication implements IApplication {
	...
	private final static class Messages extends NLS {
		private static final String BUNDLE_NAME = "org.codesearch.org.eclipse.jdt.core.formatter.messages";//$NON-NLS-1$
	...
	private void formatFile(File file, CodeFormatter codeFormatter) {
		...
		try {
			...
			String contents = new String(org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(file, null));
