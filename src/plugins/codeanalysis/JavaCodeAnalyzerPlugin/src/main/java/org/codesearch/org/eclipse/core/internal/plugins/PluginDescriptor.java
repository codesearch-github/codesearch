...
package org.codesearch.org.eclipse.core.internal.plugins;
...
import org.codesearch.org.eclipse.osgi.service.resolver.BundleSpecification;
...
public class PluginDescriptor implements IPluginDescriptor {
	...
	public IExtension[] getExtensions() {
		return org.codesearch.org.eclipse.core.internal.runtime.InternalPlatform.getDefault().getRegistry().getExtensions(getId());
	}
	...
	public PluginRegistry getPluginRegistry() {
		return (PluginRegistry) org.codesearch.org.eclipse.core.internal.plugins.InternalPlatform.getPluginRegistry();
	}
	...
	private void logError(IStatus status) {
		InternalPlatform.getDefault().getLog(org.codesearch.org.eclipse.core.internal.runtime.InternalPlatform.getDefault().getBundleContext().getBundle()).log(status);
	}
