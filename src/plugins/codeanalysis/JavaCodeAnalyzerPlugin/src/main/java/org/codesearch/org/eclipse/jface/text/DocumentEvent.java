...
public class DocumentEvent {
	 ...
	 * If the <code>org.codesearch.org.eclipse.text/debug/DocumentEvent/assertTextNotNull</code>
	 * system property is <code>true</code>
	 *
	 * @since 3.3
	 */
	private static final boolean ASSERT_TEXT_NOT_NULL= Boolean.getBoolean("org.codesearch.org.eclipse.text/debug/DocumentEvent/assertTextNotNull"); //$NON-NLS-1$
