...
public class Activator implements BundleActivator, ServiceTrackerCustomizer {
	...
	public static final String PI_PREFERENCES = "org.codesearch.org.eclipse.equinox.preferences"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		...
		registryServiceTracker = new ServiceTracker(bundleContext, "org.codesearch.org.eclipse.core.runtime.IExtensionRegistry", this); //$NON-NLS-1$
