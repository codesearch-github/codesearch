...
import org.codesearch.org.eclipse.jdt.core.JavaConventions;
import org.codesearch.org.eclipse.jdt.core.IMemberValuePair;
import org.codesearch.org.eclipse.jdt.core.IJavaProject;
import org.codesearch.org.eclipse.jdt.core.IMethod;
import org.codesearch.org.eclipse.jdt.core.JavaModelException;
import org.codesearch.org.eclipse.jdt.core.Signature;
import org.codesearch.org.eclipse.jdt.core.IAnnotation;
...
import org.codesearch.org.eclipse.jdt.core.IJavaModelStatusConstants;
import org.codesearch.org.eclipse.jdt.core.IType;
import org.codesearch.org.eclipse.jdt.core.IPackageFragment;
import org.codesearch.org.eclipse.jdt.core.JavaCore;
import org.codesearch.org.eclipse.jdt.core.IClassFile;
...
import org.codesearch.org.eclipse.core.filesystem.EFS;
import org.codesearch.org.eclipse.core.filesystem.IFileStore;
import org.codesearch.org.eclipse.core.resources.*;
import org.codesearch.org.eclipse.core.runtime.*;
import org.codesearch.org.eclipse.core.runtime.content.IContentType;
import org.codesearch.org.eclipse.core.runtime.preferences.IScopeContext;
import org.codesearch.org.eclipse.core.runtime.preferences.InstanceScope;
import org.codesearch.org.eclipse.jdt.core.*;
import org.codesearch.org.eclipse.jdt.core.compiler.CharOperation;
import org.codesearch.org.eclipse.jdt.core.dom.ASTNode;
import org.codesearch.org.eclipse.jdt.core.dom.ArrayType;
import org.codesearch.org.eclipse.jdt.core.dom.ParameterizedType;
import org.codesearch.org.eclipse.jdt.core.dom.PrimitiveType;
import org.codesearch.org.eclipse.jdt.core.dom.QualifiedType;
import org.codesearch.org.eclipse.jdt.core.dom.SimpleType;
import org.codesearch.org.eclipse.jdt.core.dom.Type;
import org.codesearch.org.eclipse.jdt.core.dom.WildcardType;
import org.codesearch.org.eclipse.jdt.core.util.IClassFileAttribute;
import org.codesearch.org.eclipse.jdt.core.util.IClassFileReader;
import org.codesearch.org.eclipse.jdt.core.util.ICodeAttribute;
import org.codesearch.org.eclipse.jdt.core.util.IFieldInfo;
import org.codesearch.org.eclipse.jdt.core.util.IMethodInfo;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.classfmt.ClassFileReader;
import org.codesearch.org.eclipse.jdt.internal.compiler.classfmt.ClassFormatException;
import org.codesearch.org.eclipse.jdt.internal.compiler.env.ClassSignature;
import org.codesearch.org.eclipse.jdt.internal.compiler.env.EnumConstantSignature;
import org.codesearch.org.eclipse.jdt.internal.compiler.env.IBinaryAnnotation;
import org.codesearch.org.eclipse.jdt.internal.compiler.env.IDependent;
...
import org.codesearch.org.eclipse.jdt.internal.core.Annotation;
import org.codesearch.org.eclipse.jdt.internal.core.ClassFile;
import org.codesearch.org.eclipse.jdt.internal.core.JavaElement;
import org.codesearch.org.eclipse.jdt.internal.core.JavaModelManager;
import org.codesearch.org.eclipse.jdt.internal.core.Member;
import org.codesearch.org.eclipse.jdt.internal.core.MemberValuePair;
import org.codesearch.org.eclipse.jdt.internal.core.PackageFragment;
import org.codesearch.org.eclipse.jdt.internal.core.PackageFragmentRoot;
import org.codesearch.org.eclipse.jface.text.BadLocationException;
import org.codesearch.org.eclipse.text.edits.MalformedTreeException;
...
public class Util {
	...
	public static boolean equalArraysOrNull(Object[] a, Object[] b) {
		...
		// where the first part is always the same (e.g. org.codesearch.org.eclipse.jdt)
	...
	private static IFile findFirstClassFile(IFolder folder) {
		try {
			...
			for (int i = 0, max = members.length; i < max; i++) {
				...
				} else if (org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(member.getName())) {
					return (IFile) member;
				}
			}
				...
				try {
					...
					if (path != null) {
						...
						for (Enumeration e= jar.entries(); e.hasMoreElements();) {
							...
							if (org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(entryName)) {
	...
	public static String getLineSeparator(String text, IJavaProject project) {
		...
		return org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.LINE_SEPARATOR;
	}
				...
				case ARGUMENTS_DELIMITER :
					...
					if (next == ARGUMENTS_DELIMITER) {
						...
						if (EMPTY_ARGUMENT.equals(currentArgumentContents)) {
							currentArgumentContents = org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING;
						}
	...
	public static byte[] getResourceContentsAsByteArray(IFile file) throws JavaModelException {
		...
		try {
			return org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsByteArray(stream, -1);
		} catch (IOException e) {
	...
	public static char[] getResourceContentsAsCharArray(IFile file, String encoding) throws JavaModelException {
		...
		try {
			return org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsCharArray(stream, (int) length, encoding);
		} catch (IOException e) {
			throw new JavaModelException(e, IJavaModelStatusConstants.IO_EXCEPTION);
		} finally {
			try {
	...
	public static JavaElement getUnresolvedJavaElement(MethodBinding methodBinding, WorkingCopyOwner workingCopyOwner, BindingsToNodesMap bindingsToNodes) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = bindingsToNodes == null ? null : bindingsToNodes.get(methodBinding);
		if (node != null && !declaringType.isBinary()) {
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding original = methodBinding.original();
	...
	public static JavaElement getUnresolvedJavaElement(TypeBinding typeBinding, WorkingCopyOwner workingCopyOwner, BindingsToNodesMap bindingsToNodes) {
		...
		switch (typeBinding.kind()) {
			case Binding.ARRAY_TYPE :
				typeBinding = ((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ArrayBinding) typeBinding).leafComponentType();
		...
		if (referenceBinding.isLocalType() || referenceBinding.isAnonymousType()) {
			...
			if (org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(fileName)) {
				int jarSeparator = CharOperation.indexOf(IDependent.JAR_FILE_ENTRY_SEPARATOR, fileName);
				int pkgEnd = CharOperation.lastIndexOf('/', fileName); // pkgEnd is exclusive
				if (pkgEnd == -1)
					pkgEnd = CharOperation.lastIndexOf(File.separatorChar, fileName);
			...
			try {
				int sourceStart = ((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) referenceBinding).sourceStart;
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Binding declaringElement = ((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding) referenceBinding).declaringElement;
	...
	public final static boolean isExcluded(IPath resourcePath, char[][] inclusionPatterns, char[][] exclusionPatterns, boolean isFolderPath) {
		...
		return org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isExcluded(resourcePath.toString().toCharArray(), inclusionPatterns, exclusionPatterns, isFolderPath);
	}
	...
	public static IAnnotation getAnnotation(JavaElement parent, IBinaryAnnotation binaryAnnotation, String memberValuePairName) {
		char[] typeName = org.codesearch.org.eclipse.jdt.core.Signature.toCharArray(CharOperation.replaceOnCopy(binaryAnnotation.getTypeName(), '/', '.'));
