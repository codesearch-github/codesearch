 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.text.undo;

import java.util.ArrayList;
import java.util.List;

import org.codesearch.org.eclipse.core.commands.ExecutionException;
import org.codesearch.org.eclipse.core.commands.operations.AbstractOperation;
import org.codesearch.org.eclipse.core.commands.operations.IContextReplacingOperation;
import org.codesearch.org.eclipse.core.commands.operations.IOperationHistory;
import org.codesearch.org.eclipse.core.commands.operations.IOperationHistoryListener;
import org.codesearch.org.eclipse.core.commands.operations.IUndoContext;
import org.codesearch.org.eclipse.core.commands.operations.IUndoableOperation;
import org.codesearch.org.eclipse.core.commands.operations.ObjectUndoContext;
import org.codesearch.org.eclipse.core.commands.operations.OperationHistoryEvent;
import org.codesearch.org.eclipse.core.commands.operations.OperationHistoryFactory;
...
import org.codesearch.org.eclipse.jface.text.DocumentEvent;
import org.codesearch.org.eclipse.jface.text.IDocument;
import org.codesearch.org.eclipse.jface.text.IDocumentExtension4;
import org.codesearch.org.eclipse.jface.text.IDocumentListener;
import org.codesearch.org.eclipse.jface.text.TextUtilities;
 ...
 * @see org.codesearch.org.eclipse.jface.text.IDocument
 * @since 3.2
...
public class DocumentUndoManager implements IDocumentUndoManager {
	...
	private static class UndoableTextChange extends AbstractOperation {
		...
		/*
		 * @see org.codesearch.org.eclipse.core.commands.operations.IUndoableOperation#dispose()
		 */
		public void dispose() {
			reinitialize();
		}
		...
		/*
		 * @see org.codesearch.org.eclipse.core.commands.operations.IUndoableOperation#canUndo()
		 */
		...
		/*
		 * @see org.codesearch.org.eclipse.core.commands.operations.IUndoableOperation#canRedo()
		 */
		...
		/*
		 * @see org.codesearch.org.eclipse.core.commands.operations.IUndoableOperation#canExecute()
		 */
		...
		/*
		 * @see org.codesearch.org.eclipse.core.commands.operations.IUndoableOperation.IUndoableOperation#execute(IProgressMonitor, IAdaptable)
		 */
	...
	private static class UndoableCompoundTextChange extends UndoableTextChange {
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#undo(org.codesearch.org.eclipse.core.runtime.IProgressMonitor, org.codesearch.org.eclipse.core.runtime.IAdaptable)
		 */
		public IStatus undo(IProgressMonitor monitor, IAdaptable uiInfo) {
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#redo(org.codesearch.org.eclipse.core.runtime.IProgressMonitor, org.codesearch.org.eclipse.core.runtime.IAdaptable)
		 */
		public IStatus redo(IProgressMonitor monitor, IAdaptable uiInfo) {
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#updateTextChange()
		 */
		protected void updateTextChange() {
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#createCurrent()
		 */
		protected UndoableTextChange createCurrent() {
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#commit()
		 */
		protected void commit() {
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#isValid()
		 */
		protected boolean isValid() {
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#getUndoModificationStamp()
		 */
		protected long getUndoModificationStamp() {
			if (fStart > -1)
		...
		/*
		 * @see org.codesearch.org.eclipse.text.undo.UndoableTextChange#getRedoModificationStamp()
		 */
		protected long getRedoModificationStamp() {
			if (fStart > -1)
	...
	private class DocumentListener implements IDocumentListener {
		...
		/*
		 * @see org.codesearch.org.eclipse.jface.text.IDocumentListener#documentAboutToBeChanged(org.codesearch.org.eclipse.jface.text.DocumentEvent)
		 */
		...
		/*
		 * @see org.codesearch.org.eclipse.jface.text.IDocumentListener#documentChanged(org.codesearch.org.eclipse.jface.text.DocumentEvent)
		 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#addDocumentUndoListener(org.codesearch.org.eclipse.jface.text.IDocumentUndoListener)
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#removeDocumentUndoListener(org.codesearch.org.eclipse.jface.text.IDocumentUndoListener)
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#getUndoContext()
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#commit()
	 */
	public void commit() {
	...
	/*
	 * @see org.codesearch.org.eclipse.text.undo.IDocumentUndoManager#reset()
	 */
	public void reset() {
		if (isConnected()) {
			shutdown();
	...
	/*
	 * @see org.codesearch.org.eclipse.text.undo.IDocumentUndoManager#redoable()
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.text.undo.IDocumentUndoManager#undoable()
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.text.undo.IDocumentUndoManager#undo()
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#connect(java.lang.Object)
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#disconnect(java.lang.Object)
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#beginCompoundChange()
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#endCompoundChange()
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#setUndoLimit(int)
	 */
	...
	/*
	 * @see org.codesearch.org.eclipse.jface.text.IDocumentUndoManager#transferUndoHistory(IDocumentUndoManager)
	 */
