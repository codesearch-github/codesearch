...
class MemberValuePairBinding implements IMemberValuePairBinding {
	...
	static Object buildDOMValue(final Object internalObject, BindingResolver resolver) {
		...
		} else if (internalObject instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
			return resolver.getTypeBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) internalObject);
		} else if (internalObject instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding) {
			return resolver.getAnnotationInstance((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding) internalObject);
		} else if (internalObject instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.FieldBinding) {
			return resolver.getVariableBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.FieldBinding) internalObject);
