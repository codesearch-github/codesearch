 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.swt.browser;
...
import org.codesearch.org.eclipse.swt.widgets.*;
import org.codesearch.org.eclipse.swt.graphics.*;
import org.codesearch.org.eclipse.swt.internal.*;
import org.codesearch.org.eclipse.swt.internal.mozilla.*;
import org.codesearch.org.eclipse.swt.internal.mozilla.init.*;
import org.codesearch.org.eclipse.swt.layout.*;
...
class Mozilla extends WebBrowser {
	...
	static final String DISPOSE_LISTENER_HOOKED = "org.codesearch.org.eclipse.swt.browser.Mozilla.disposeListenerHooked"; //$NON-NLS-1$
	...
	static final String XULRUNNER_PATH = "org.codesearch.org.eclipse.swt.browser.XULRunnerPath"; //$NON-NLS-1$

	// TEMPORARY CODE
	static final String GRE_INITIALIZED = "org.codesearch.org.eclipse.swt.browser.XULRunnerInitialized"; //$NON-NLS-1$
...
public boolean create (Composite parent, int style) {
	...
	if (!Initialized) {
		...
		* to set the org.codesearch.org.eclipse.swt.browser.XULRunnerPath system property to point
		...
		* org.codesearch.org.eclipse.swt.browser.XULRunnerInitializer the first time a Mozilla-
		* based Browser is created.   A client wishing to use this hook can do so
		* by creating a fragment of org.codesearch.org.eclipse.swt that implements this class and
		* sets the system property in its static initializer.
		*/
		if (mozillaPath == null) {
			try {
				Class.forName ("org.codesearch.org.eclipse.swt.browser.XULRunnerInitializer"); //$NON-NLS-1$
