...
import org.codesearch.org.eclipse.osgi.service.runnable.ParameterizedRunnable;
...
public class EclipseAppContainer implements IRegistryEventListener, SynchronousBundleListener, ServiceTrackerCustomizer {
	private static final String PI_RUNTIME = "org.codesearch.org.eclipse.core.runtime"; //$NON-NLS-1$
	...
	private static final String EXT_ERROR_APP = "org.codesearch.org.eclipse.equinox.app.error"; //$NON-NLS-1$
