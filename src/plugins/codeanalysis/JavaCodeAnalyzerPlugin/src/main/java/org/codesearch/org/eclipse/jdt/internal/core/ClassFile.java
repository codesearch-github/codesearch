...
import org.codesearch.org.eclipse.jdt.core.SourceRange;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.env.IBinaryType;
...
public void codeComplete(int offset, ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(offset, new org.codesearch.org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
...
public byte[] getBytes() throws JavaModelException {
	...
	if (pkg instanceof JarPackageFragment) {
		...
		try {
			...
			if (ze != null) {
				return org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getZipEntryByteContent(ze, zip);
			}
...
private IBinaryType getJarBinaryTypeInfo(PackageFragment pkg, boolean fullyInitialize) throws CoreException, IOException, ClassFormatException {
	...
	try {
		...
		ZipEntry ze = zip.getEntry(entryName);
		if (ze != null) {
			byte contents[] = org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getZipEntryByteContent(ze, zip);
 ...
 * @deprecated
 */
public IJavaElement getWorkingCopy(IProgressMonitor monitor, org.codesearch.org.eclipse.jdt.core.IBufferFactory factory) throws JavaModelException {
 ...
 */
public void codeComplete(int offset, final org.codesearch.org.eclipse.jdt.core.ICodeCompletionRequestor requestor) throws JavaModelException {
