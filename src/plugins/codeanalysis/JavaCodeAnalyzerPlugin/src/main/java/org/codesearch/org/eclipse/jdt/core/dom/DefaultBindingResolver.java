...
import org.codesearch.org.eclipse.jdt.core.WorkingCopyOwner;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.ast.JavadocImplicitTypeReference;
import org.codesearch.org.eclipse.jdt.internal.compiler.ast.ImportReference;
import org.codesearch.org.eclipse.jdt.internal.compiler.ast.JavadocAllocationExpression;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.ast.JavadocQualifiedTypeReference;
import org.codesearch.org.eclipse.jdt.internal.compiler.ast.JavadocSingleNameReference;
import org.codesearch.org.eclipse.jdt.internal.compiler.ast.JavadocSingleTypeReference;
import org.codesearch.org.eclipse.jdt.internal.compiler.ast.Literal;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ArrayBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Binding;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ElementValuePair;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.FieldBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.LocalVariableBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.LookupEnvironment;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ParameterizedGenericMethodBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ProblemFieldBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ProblemReasons;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ProblemReferenceBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Scope;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TagBits;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeConstants;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeIds;
import org.codesearch.org.eclipse.jdt.internal.compiler.problem.AbortCompilation;
...
class DefaultBindingResolver extends BindingResolver {
	...
	IBinding getBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Binding binding) {
		switch (binding.kind()) {
			case Binding.PACKAGE:
				return getPackageBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) binding);
			case Binding.TYPE:
			case Binding.BASE_TYPE:
			case Binding.GENERIC_TYPE:
			case Binding.PARAMETERIZED_TYPE:
			case Binding.RAW_TYPE:
				return getTypeBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) binding);
			case Binding.ARRAY_TYPE:
			case Binding.TYPE_PARAMETER:
				return new TypeBinding(this, (org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) binding);
			case Binding.METHOD:
				return getMethodBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) binding);
			case Binding.FIELD:
			case Binding.LOCAL:
				return getVariableBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.VariableBinding) binding);
		}
		return null;
	}
	...
	Util.BindingsToNodesMap getBindingsToNodesMap() {
		return new Util.BindingsToNodesMap() {
			public org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode get(Binding binding) {
				return (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode)
					DefaultBindingResolver.this.newAstToOldAst.get(DefaultBindingResolver.this.bindingsToAstNodes.get(binding));
			}
		};
	}

	synchronized org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
		return (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(currentNode);
	}

	/*
	 * Method declared on BindingResolver.
	 */
	synchronized IMethodBinding getMethodBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding) {
 		if (methodBinding != null && !methodBinding.isValidBinding()) {
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding =
				(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding) methodBinding;
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IPackageBinding getPackageBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding) {
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized ITypeBinding getTypeBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding referenceBinding) {
			...
			switch(referenceBinding.problemId()) {
				...
				case ProblemReasons.NonStaticReferenceInStaticContext :
					if (referenceBinding instanceof ProblemReferenceBinding) {
						...
						org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding2 = problemReferenceBinding.closestMatch();
	...
	synchronized IVariableBinding getVariableBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.VariableBinding variableBinding, VariableDeclaration variableDeclaration) {
		if (this.isRecoveringBindings) {
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IVariableBinding getVariableBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.VariableBinding variableBinding) {
		if (variableBinding != null) {
			if (variableBinding.isValidBinding()) {
				org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
	...
	synchronized IAnnotationBinding getAnnotationInstance(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalInstance) {
	...
	boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation) {
		...
		if (oldNode instanceof MessageSend) {
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.BindingResolver#recordScope(ASTNode, BlockScope)
	 */
	...
	boolean resolveBoxing(Expression expression) {
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression compilerExpression = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression) node;
	...
	synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression) {
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node != null && (node.bits & org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.BindingResolver#resolveConstructor(org.codesearch.org.eclipse.jdt.core.dom.EnumConstantDeclaration)
	 */
	IMethodBinding resolveConstructor(EnumConstantDeclaration enumConstantDeclaration) {
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(enumConstantDeclaration);
		if (node instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration) {
		...
		try {
			switch(expression.getNodeType()) {
				case ASTNode.CLASS_INSTANCE_CREATION :
					org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode astNode = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
					if (astNode instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) {
						// anonymous type case
						org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) astNode;
				...
				case ASTNode.SINGLE_MEMBER_ANNOTATION :
					org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression compilerExpression = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression) this.newAstToOldAst.get(expression);
	...
	synchronized IBinding resolveImport(ImportDeclaration importDeclaration) {
		...
		try {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(importDeclaration);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
				final boolean isStatic = importReference.isStatic();
				if ((importReference.bits & org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0) {
					...
					if (binding != null) {
						if (isStatic) {
							if (binding instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
								ITypeBinding typeBinding = this.getTypeBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) binding);
								return typeBinding == null ? null : typeBinding;
							}
						} else {
							if ((binding.kind() & Binding.PACKAGE) != 0) {
								IPackageBinding packageBinding = getPackageBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) binding);
								if (packageBinding == null) {
									return null;
								}
					...
					if (binding != null) {
						if (isStatic) {
							...
							} else if (binding instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) {
								// it is a type
								return getMethodBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding)binding);
							}
						} else {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.BindingResolver#resolveMember(org.codesearch.org.eclipse.jdt.core.dom.AnnotationTypeMemberDeclaration)
	 */
	...
	synchronized ITypeBinding resolveTypeBindingForName(Name name) {
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(name);
		...
		if (node instanceof QualifiedNameReference) {
			...
			if (index < indexOfFirstFieldBinding) {
				...
				if (binding instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) {
					return null;
				} else if (binding instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
					// it is a type
					return this.getTypeBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
				}
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
					if (type == null) { // array length scenario
						// use type from first binding (no capture needed for array type)
						switch (qualifiedNameReference.bits & org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode.RestrictiveFlagMASK) {
							case Binding.FIELD:
			...
			if (index >= 0) {
				...
				if (importReferenceLength == index) {
					try {
						binding = this.scope.getImport(CharOperation.subarray(importReference.tokens, 0, index), (importReference.bits & org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0, importReference.isStatic());
					} catch (AbortCompilation e) {
						// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=53357
					}
				} else {
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding != null) {
				return typeBinding;
			}
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
			if (binding != null) {
		...
		} else if (node instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeParameter) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeParameter typeParameter = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeParameter) node;
			return this.getTypeBinding(typeParameter.binding);
		} else if (node instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.MemberValuePair) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.MemberValuePair memberValuePair = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.MemberValuePair) node;
	...
	synchronized IBinding resolveName(Name name) {
		...
		if (node instanceof QualifiedNameReference) {
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					if (binding != null) {
						if (binding.isValidBinding()) {
							return this.getVariableBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.VariableBinding) binding);
			...
			if (index >= 0) {
				...
				if (binding != null) {
					if (binding instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) {
						...
						// it is a type
						return this.getTypeBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
					} else if (binding instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.FieldBinding) {
						// it is a type
						return this.getVariableBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.FieldBinding)binding);
					} else if (binding instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) {
						// it is a type
						return getMethodBinding((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding)binding);
					} else {
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration[] types = compilationUnitDeclaration.types;
			if (types == null || types.length == 0) {
				return null;
			}
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration type = types[0];
			if (type != null) {
	...
	synchronized IPackageBinding resolvePackage(PackageDeclaration pkg) {
		if (this.scope == null) return null;
		try {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(pkg);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
	...
	synchronized IBinding resolveReference(MemberRef ref) {
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression expression = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression) this.newAstToOldAst.get(ref);
     ...
     * @since 3.2
	 */
	synchronized IMemberValuePairBinding resolveMemberValuePair(org.codesearch.org.eclipse.jdt.core.dom.MemberValuePair memberValuePair) {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.BindingResolver#resolveType(org.codesearch.org.eclipse.jdt.core.dom.AnnotationTypeDeclaration)
	 */
	ITypeBinding resolveType(AnnotationTypeDeclaration type) {
		final Object node = this.newAstToOldAst.get(type);
		if (node instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding == null) {
				return null;
	...
	synchronized ITypeBinding resolveType(AnonymousClassDeclaration type) {
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		if (node != null && (node.bits & org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.BindingResolver#resolveType(org.codesearch.org.eclipse.jdt.core.dom.EnumDeclaration)
	 */
	...
	synchronized ITypeBinding resolveType(Type type) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding = null;
		if (node != null) {
			if (node instanceof ParameterizedQualifiedTypeReference) {
				...
				org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
				int index;
			...
			if (((PrimitiveType) type).getPrimitiveTypeCode() == PrimitiveType.VOID) {
				return this.getTypeBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.VOID);
			}
		}
		return null;
	}
	...
	synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter) {
		...
		if (node instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeParameter) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeParameter typeParameter2 = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.TypeParameter) node;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.BindingResolver#resolveVariable(org.codesearch.org.eclipse.jdt.core.dom.EnumConstantDeclaration)
	 */
	...
	synchronized IVariableBinding resolveVariable(VariableDeclaration variable) {
		...
		if (node instanceof AbstractVariableDeclaration) {
			...
			if (abstractVariableDeclaration instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration) {
				org.codesearch.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration = (org.codesearch.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration) abstractVariableDeclaration;
	...
	synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode) {
		...
		if (oldNode instanceof org.codesearch.org.eclipse.jdt.internal.compiler.ast.Annotation) {
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.Annotation internalAstNode =
				(org.codesearch.org.eclipse.jdt.internal.compiler.ast.Annotation) oldNode;
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized void store(ASTNode node, org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode oldASTNode) {
	...
	ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions) {
		...
		if (typeBinding.isArray()) {
 		...
 		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding leafTypeBinding = null;
 		if (leafComponentType.isPrimitive()) {
 	 		String name = leafComponentType.getBinaryName();
			switch(name.charAt(0)) {
				case 'I' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.INT;
					break;
				case 'B' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.BYTE;
					break;
				case 'Z' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.BOOLEAN;
					break;
				case 'C' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.CHAR;
					break;
				case 'J' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.LONG;
					break;
				case 'S' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.SHORT;
					break;
				case 'D' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.DOUBLE;
					break;
				case 'F' :
					leafTypeBinding = org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.FLOAT;
					break;
				case 'V' :
