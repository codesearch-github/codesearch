...
import org.codesearch.org.eclipse.core.commands.Command;
import org.codesearch.org.eclipse.core.commands.CommandEvent;
import org.codesearch.org.eclipse.core.commands.CommandManager;
import org.codesearch.org.eclipse.core.commands.ExecutionEvent;
import org.codesearch.org.eclipse.core.commands.ExecutionException;
import org.codesearch.org.eclipse.core.commands.ICommandListener;
import org.codesearch.org.eclipse.core.commands.NotEnabledException;
import org.codesearch.org.eclipse.core.commands.ParameterizedCommand;
import org.codesearch.org.eclipse.core.commands.common.NotDefinedException;
...
import org.codesearch.org.eclipse.jface.bindings.BindingManager;
import org.codesearch.org.eclipse.jface.bindings.BindingManagerEvent;
import org.codesearch.org.eclipse.jface.bindings.IBindingManagerListener;
import org.codesearch.org.eclipse.jface.bindings.Trigger;
import org.codesearch.org.eclipse.jface.bindings.TriggerSequence;
import org.codesearch.org.eclipse.jface.bindings.keys.KeySequence;
import org.codesearch.org.eclipse.jface.bindings.keys.KeyStroke;
import org.codesearch.org.eclipse.jface.bindings.keys.SWTKeySupport;
...
public final class ExternalActionManager {
	...
	public static class CommandCallback implements
		...
		/**
		 * @see org.codesearch.org.eclipse.jface.action.ExternalActionManager.ICallback#addPropertyChangeListener(String,
		...
		/**
		 * @see org.codesearch.org.eclipse.jface.action.ExternalActionManager.ICallback#getAccelerator(String)
		 */
		...
		/**
		 * @see org.codesearch.org.eclipse.jface.action.ExternalActionManager.ICallback#getAcceleratorText(String)
		 */
		...
		/**
		 * @see org.codesearch.org.eclipse.jface.action.ExternalActionManager.ICallback#isAcceleratorInUse(int)
		 */
			...
			if (commandId != null) {
				...
				if (!command.isDefined()
					...
					IStatus status = new Status(IStatus.ERROR,
							"org.codesearch.org.eclipse.jface", //$NON-NLS-1$
					...
					command.addCommandListener(new ICommandListener() {
						 ...
						 * (non-Javadoc)
						 * 
						 * @see org.codesearch.org.eclipse.ui.commands.ICommandListener#commandChanged(org.codesearch.org.eclipse.ui.commands.CommandEvent)
						 */
		...
		/**
		 * @see org.codesearch.org.eclipse.jface.action.ExternalActionManager.ICallback#removePropertyChangeListener(String,
		 *      IPropertyChangeListener)
		 */
