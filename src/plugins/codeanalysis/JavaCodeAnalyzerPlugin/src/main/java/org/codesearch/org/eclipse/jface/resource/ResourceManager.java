...
public abstract class ResourceManager {
     ...
     * them. For example, never call {@link org.codesearch.org.eclipse.swt.graphics.Resource#dispose()} 
    ...
    public final Image createImageWithDefault(ImageDescriptor descriptor) {
        ...
        try {
			...
			Policy.getLog().log(
					new Status(IStatus.WARNING, "org.codesearch.org.eclipse.jface", 0, //$NON-NLS-1$
