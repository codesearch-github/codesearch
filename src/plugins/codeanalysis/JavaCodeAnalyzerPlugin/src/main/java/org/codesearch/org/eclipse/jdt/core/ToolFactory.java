...
import org.codesearch.org.eclipse.jdt.core.compiler.IScanner;
import org.codesearch.org.eclipse.jdt.core.compiler.ITerminalSymbols;
...
import org.codesearch.org.eclipse.jdt.core.util.ClassFileBytesDisassembler;
import org.codesearch.org.eclipse.jdt.core.util.ClassFormatException;
...
import org.codesearch.org.eclipse.jdt.internal.core.util.ClassFileReader;
import org.codesearch.org.eclipse.jdt.internal.core.util.Disassembler;
import org.codesearch.org.eclipse.jdt.internal.core.util.PublicScanner;
...
public class ToolFactory {
	 ...
	 * extension point "org.codesearch.org.eclipse.jdt.core.codeFormatter". If unable to find a registered extension, the factory
	 ...
	 *
	 * @return a classfile bytecode disassembler
	 * @see org.codesearch.org.eclipse.jdt.core.util.IClassFileDisassembler
	 * @deprecated Use {@link #createDefaultClassFileBytesDisassembler()} instead
	 */
	public static org.codesearch.org.eclipse.jdt.core.util.IClassFileDisassembler createDefaultClassFileDisassembler(){
		class DeprecatedDisassembler extends Disassembler implements org.codesearch.org.eclipse.jdt.core.util.IClassFileDisassembler {
		...
		if (root != null){
			try {
				if (root instanceof JarPackageFragmentRoot) {
					...
					String entryName = org.codesearch.org.eclipse.jdt.internal.core.util.Util.concatWith(packageFragment.names, classFileName, '/');
	...
	public static ICodeFormatter createDefaultCodeFormatter(Map options){
		if (options == null) options = JavaCore.getOptions();
		return new org.codesearch.org.eclipse.jdt.internal.formatter.old.CodeFormatter(options);
	}
	 ...
	 * considered as valid line separators.
  	 * @return a scanner
	 * @see org.codesearch.org.eclipse.jdt.core.compiler.IScanner
