...
import org.codesearch.org.eclipse.jdt.core.ILocalVariable;
import org.codesearch.org.eclipse.jdt.core.IOpenable;
...
public class LocalVariable extends SourceRefElement implements ILocalVariable {
	...
	public LocalVariable(
			...
			int nameEnd,
			String typeSignature,
			org.codesearch.org.eclipse.jdt.internal.compiler.ast.Annotation[] astAnnotations) {
	...
	private IAnnotation[] getAnnotations(org.codesearch.org.eclipse.jdt.internal.compiler.ast.Annotation[] astAnnotations) {
		int length;
	...
	private IAnnotation getAnnotation(final org.codesearch.org.eclipse.jdt.internal.compiler.ast.Annotation annotation, JavaElement parentElement) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.ast.MemberValuePair[] astMemberValuePairs = annotation.memberValuePairs();
		int length;
		IMemberValuePair[] memberValuePairs;
		if (astMemberValuePairs == null || (length = astMemberValuePairs.length) == 0) {
			...
			for (int i = 0; i < length; i++) {
				org.codesearch.org.eclipse.jdt.internal.compiler.ast.MemberValuePair astMemberValuePair = astMemberValuePairs[i];
	...
	private Object getAnnotationMemberValue(MemberValuePair memberValuePair, Expression expression, JavaElement parentElement) {
		if (expression instanceof NullLiteral) {
			...
			return getAnnotation((org.codesearch.org.eclipse.jdt.internal.compiler.ast.Annotation) expression, parentElement);
