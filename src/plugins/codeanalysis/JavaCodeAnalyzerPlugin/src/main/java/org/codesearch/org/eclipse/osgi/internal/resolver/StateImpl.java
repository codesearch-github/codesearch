 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.osgi.internal.resolver;
...
import org.codesearch.org.eclipse.osgi.framework.util.*;
import org.codesearch.org.eclipse.osgi.internal.baseadaptor.StateManager;
		...
		synchronized (this.monitor) {
			try {
				...
				if (StateManager.DEBUG_PLATFORM_ADMIN_RESOLVER) {
					...
					FrameworkDebugOptions.getDefault().setOption("org.codesearch.org.eclipse.core.runtime.adaptor/resolver/timing/value", Long.toString(cumulativeTime)); //$NON-NLS-1$
				}
