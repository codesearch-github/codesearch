...
/**
 * Extension interface for {@link org.codesearch.org.eclipse.jface.text.ISlaveDocumentManager}.
 * <p>
 * Adds access to the list of all slave documents for a given master document.
 *
 * @see org.codesearch.org.eclipse.jface.text.ISlaveDocumentManager
 * @since 3.0
 */
