...
protected boolean isBoxingCompatible(TypeBinding expressionType, TypeBinding targetType, Expression expression, Scope scope) {
	...
	return expressionType.isBaseType()  // narrowing then boxing ?
		...
		&& scope.compilerOptions().sourceLevel >= org.codesearch.org.eclipse.jdt.internal.compiler.classfmt.ClassFileConstants.JDK1_5 // autoboxing
...
/** 
 * Implementation of {@link org.codesearch.org.eclipse.jdt.internal.compiler.lookup.InvocationSite#expectedType}
 * suitable at this level. Subclasses should override as necessary.
 * @see org.codesearch.org.eclipse.jdt.internal.compiler.lookup.InvocationSite#expectedType()
 */
