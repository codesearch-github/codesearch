...
import org.codesearch.org.eclipse.osgi.framework.log.*;
import org.codesearch.org.eclipse.osgi.service.datalocation.*;
...
public class ConfigurationActivator implements BundleActivator, IBundleGroupProvider, IConfigurationConstants {
	...
	public static String PI_CONFIGURATOR = "org.codesearch.org.eclipse.update.configurator"; //$NON-NLS-1$
	public static final String LAST_CONFIG_STAMP = "last.config.stamp"; //$NON-NLS-1$
	public static final String NAME_SPACE = "org.codesearch.org.eclipse.update"; //$NON-NLS-1$
	...
	public static boolean isReconciling() {
		String reconcile = context.getProperty("org.codesearch.org.eclipse.update.reconcile"); //$NON-NLS-1$
	...
	private void initialize() throws Exception {
		...
		// create the name space directory for update (configuration/org.codesearch.org.eclipse.update)
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.runtime.IBundleGroupProvider#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.runtime.IBundleGroupProvider#getBundleGroups()
	 */
