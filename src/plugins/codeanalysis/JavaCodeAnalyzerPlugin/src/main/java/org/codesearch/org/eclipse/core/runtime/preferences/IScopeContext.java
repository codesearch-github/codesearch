...
public interface IScopeContext {
	 ...
	 * the preference is associated with (e.g. the "org.codesearch.org.eclipse.core.resources" 
	 ...
	 * <code>new InstanceScope().getNode("org.codesearch.org.eclipse.core.resources");</code>
	 * returns the preference node in the instance scope where the preferences
	 * for "org.codesearch.org.eclipse.core.resources" are stored.
	 * </p>
