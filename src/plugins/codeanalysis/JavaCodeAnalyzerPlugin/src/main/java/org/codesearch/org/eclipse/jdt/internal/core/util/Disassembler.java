...
import org.codesearch.org.eclipse.jdt.core.util.*;
...
public class Disassembler extends ClassFileBytesDisassembler {
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.util.ClassFileBytesDisassembler#disassemble(byte[], java.lang.String)
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.util.ClassFileBytesDisassembler#disassemble(byte[], java.lang.String, int)
	 */
	...
	/**
	 * @see #disassemble(org.codesearch.org.eclipse.jdt.core.util.IClassFileReader, java.lang.String, int)
	 */
	...
	public String disassemble(IClassFileReader classFileReader, String lineSeparator, int mode) {
		if (classFileReader == null) return org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING;
		char[] className = classFileReader.getClassName();
		if (className == null) {
			// incomplete initialization. We cannot go further.
			return org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING;
		}
		...
		if (checkMode(mode, SYSTEM | DETAILED)) {
			...
			buffer.append(
				...
				new String[] {
					...
					+ (isDeprecated(classFileReader) ? ", deprecated" : org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING)//$NON-NLS-1$
				}));
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.util.ClassFileBytesDisassembler#getDescription()
	 */
