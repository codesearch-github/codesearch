...
class PackageBinding implements IPackageBinding {
	...
	private org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding binding;
	private String name;
	private BindingResolver resolver;
	private String[] components;

	PackageBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding binding, BindingResolver resolver) {
				...
				switch(fragType) {
					...
					case IPackageFragmentRoot.K_BINARY:
						...
						if (answer != null && answer.isBinaryType()) {
							...
							org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] binaryInstances =
								BinaryTypeBinding.createAnnotations(binaryAnnotations, this.binding.environment, missingTypeNames);
							org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] allInstances =
								org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding.addStandardAnnotations(binaryInstances, type.getTagBits(), this.binding.environment);
	...
	public IJavaElement getJavaElement() {
		...
		if (pkgs.length == 0) {
			...
			org.codesearch.org.eclipse.jdt.internal.core.util.Util.log(
				new Status(
						IStatus.WARNING,
						JavaCore.PLUGIN_ID,
	...
	public boolean isEqualTo(IBinding other) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding2 = ((PackageBinding) other).binding;
