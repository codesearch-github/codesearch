 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jface.viewers.deferred;

import java.util.Comparator;

import org.codesearch.org.eclipse.core.runtime.Assert;
import org.codesearch.org.eclipse.jface.viewers.AcceptAllFilter;
import org.codesearch.org.eclipse.jface.viewers.IFilter;
import org.codesearch.org.eclipse.jface.viewers.ILazyContentProvider;
...
public class DeferredContentProvider implements ILazyContentProvider {
	...
	private static final class TableViewerAdapter extends AbstractVirtualTable {
		...
		/* (non-Javadoc)
		 * @see org.codesearch.org.eclipse.jface.viewers.deferred.AbstractVirtualTable#flushCache(java.lang.Object)
		 */
		...
		/* (non-Javadoc)
		 * @see org.codesearch.org.eclipse.jface.viewers.deferred.AbstractVirtualTable#replace(java.lang.Object, int)
		 */
		...
		/* (non-Javadoc)
		 * @see org.codesearch.org.eclipse.jface.viewers.deferred.AbstractVirtualTable#setItemCount(int)
		 */
		...
		/* (non-Javadoc)
		 * @see org.codesearch.org.eclipse.jface.viewers.deferred.AbstractVirtualTable#getItemCount()
		 */
		...
		/* (non-Javadoc)
		 * @see org.codesearch.org.eclipse.jface.viewers.deferred.AbstractVirtualTable#getTopIndex()
		 */
		...
		/* (non-Javadoc)
		 * @see org.codesearch.org.eclipse.jface.viewers.deferred.AbstractVirtualTable#getVisibleItemCount()
		 */
		...
		/* (non-Javadoc)
		 * @see org.codesearch.org.eclipse.jface.viewers.deferred.AbstractVirtualTable#getControl()
		 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jface.viewers.IContentProvider#inputChanged(org.codesearch.org.eclipse.jface.viewers.Viewer, java.lang.Object, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jface.viewers.ILazyContentProvider#updateElement(int)
	 */
