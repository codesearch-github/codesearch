...
import org.codesearch.org.eclipse.osgi.baseadaptor.*;
import org.codesearch.org.eclipse.osgi.baseadaptor.hooks.AdaptorHook;
import org.codesearch.org.eclipse.osgi.framework.adaptor.FrameworkAdaptor;
import org.codesearch.org.eclipse.osgi.framework.console.CommandProvider;
import org.codesearch.org.eclipse.osgi.framework.debug.Debug;
import org.codesearch.org.eclipse.osgi.framework.debug.FrameworkDebugOptions;
import org.codesearch.org.eclipse.osgi.framework.internal.core.BundleHost;
import org.codesearch.org.eclipse.osgi.framework.internal.core.FrameworkProperties;
import org.codesearch.org.eclipse.osgi.framework.log.FrameworkLog;
import org.codesearch.org.eclipse.osgi.framework.log.FrameworkLogEntry;
import org.codesearch.org.eclipse.osgi.internal.baseadaptor.AdaptorUtil;
import org.codesearch.org.eclipse.osgi.service.datalocation.Location;
import org.codesearch.org.eclipse.osgi.service.pluginconversion.PluginConverter;
import org.codesearch.org.eclipse.osgi.service.resolver.PlatformAdmin;
...
public class EclipseAdaptorHook implements AdaptorHook, HookConfigurator {
	...
	public void frameworkStart(BundleContext context) throws BundleException {
		...
		registrations.add(AdaptorUtil.register(org.codesearch.org.eclipse.osgi.service.environment.EnvironmentInfo.class.getName(), EclipseEnvironmentInfo.getDefault(), context));
		...
		registrations.add(AdaptorUtil.register(org.codesearch.org.eclipse.osgi.service.localization.BundleLocalization.class.getName(), new BundleLocalizationImpl(), context));
	}
	...
	private void printStats() {
		...
		if (debugOptions == null)
			return;
		String registryParsing = debugOptions.getOption("org.codesearch.org.eclipse.core.runtime/registry/parsing/timing/value"); //$NON-NLS-1$
		...
		String constraintResolution = debugOptions.getOption("org.codesearch.org.eclipse.core.runtime.adaptor/resolver/timing/value"); //$NON-NLS-1$
