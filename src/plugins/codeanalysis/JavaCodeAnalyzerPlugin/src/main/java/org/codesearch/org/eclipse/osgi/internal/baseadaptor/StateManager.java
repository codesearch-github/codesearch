...
import org.codesearch.org.eclipse.osgi.internal.resolver.*;
...
public class StateManager implements PlatformAdmin, Runnable {
	...
	private Resolver createResolver(boolean checkPermissions) {
		return new org.codesearch.org.eclipse.osgi.internal.module.ResolverImpl(context, checkPermissions);
	}
