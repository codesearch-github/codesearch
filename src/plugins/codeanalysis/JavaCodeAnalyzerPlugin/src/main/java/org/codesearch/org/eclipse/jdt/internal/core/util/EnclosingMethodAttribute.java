...
import org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute;
...
public class EnclosingMethodAttribute extends ClassFileAttribute implements IEnclosingMethodAttribute {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute#getEnclosingClass()
	 */
	public char[] getEnclosingClass() {
		return this.enclosingClassName;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute#getMethodDeclaringClassDescriptorIndex()
	 */
	public int getEnclosingClassIndex() {
		return this.enclosingClassIndex;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute#getMethodDescriptor()
	 */
	public char[] getMethodDescriptor() {
		return this.methodDescriptor;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute#getMethodDescriptorIndex()
	 */
	public int getMethodDescriptorIndex() {
		return this.methodDescriptorIndex;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute#getMethodName()
	 */
	public char[] getMethodName() {
		return this.methodName;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute#getMethodNameIndex()
	 */
	public int getMethodNameIndex() {
		return this.methodNameIndex;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IEnclosingMethodAttribute#getMethodNameAndTypeIndex()
	 */
