...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.VariableBinding;
...
class BindingComparator {
	...
	static boolean isEqual(Binding declaringElement, Binding declaringElement2, HashSet visitedTypes) {
		if (declaringElement instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
			if (!(declaringElement2 instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding)){
				return false;
			}
			return isEqual((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaringElement,
					(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaringElement2,
					visitedTypes);
		} else if (declaringElement instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) {
			if (!(declaringElement2 instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding)) {
				return false;
			}
			return isEqual((org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) declaringElement,
					(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) declaringElement2,
					visitedTypes);
		...
		} else if (declaringElement instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) {
			if (!(declaringElement2 instanceof org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding)) {
				return false;
			}
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding = (org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) declaringElement;
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding2 = (org.codesearch.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) declaringElement2;
	...
	static boolean isEqual(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding,
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding2) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] bindings, org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] otherBindings) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] bindings, org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes) {
		if (bindings == null) {
			return otherBindings == null;
		}
		if (otherBindings == null) {
	...
	static boolean isEqual(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding, org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding, org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding2) {
