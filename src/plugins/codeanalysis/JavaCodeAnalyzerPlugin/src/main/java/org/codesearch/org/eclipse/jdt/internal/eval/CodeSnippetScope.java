 ...
 * @param kind int
 * @param parent org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Scope
 */
...
/**
 * CodeSnippetScope constructor comment.
 * @param parent org.codesearch.org.eclipse.jdt.internal.compiler.lookup.BlockScope
 */
...
public FieldBinding findFieldForCodeSnippet(TypeBinding receiverType, char[] fieldName, InvocationSite invocationSite) {
	...
	if (interfacesToVisit != null) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.util.SimpleSet interfacesSeen = new org.codesearch.org.eclipse.jdt.internal.compiler.util.SimpleSet(lastPosition * 2);
