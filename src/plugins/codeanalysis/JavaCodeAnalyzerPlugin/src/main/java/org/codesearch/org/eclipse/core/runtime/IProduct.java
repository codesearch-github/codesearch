 ...
 * For example, in the standard Eclipse UI, <code>org.codesearch.org.eclipse.ui.branding.IProductConstants</code>
 * the properties of interest to the UI.  Other clients may specify additional properties.
 * </p><p>
 * Products can be defined directly using extensions to the <code>org.codesearch.org.eclipse.core.runtime.products</code>
