 ...
 *
 * @see org.codesearch.org.eclipse.jdt.internal.core.util.ILRUCacheable
 */
public class LRUCache implements Cloneable {
	...
	protected String toStringContents() {
		...
		for (int i = 0; i < length; i++) {
			...
			unsortedKeys[i] = key;
			unsortedToStrings[i] =
				(key instanceof org.codesearch.org.eclipse.jdt.internal.core.JavaElement) ?
					((org.codesearch.org.eclipse.jdt.internal.core.JavaElement)key).getElementName() :
					key.toString();
		}
