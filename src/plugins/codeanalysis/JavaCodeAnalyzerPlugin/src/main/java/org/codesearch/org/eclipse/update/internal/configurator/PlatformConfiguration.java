 ...
 * the runtime. Configuration data is stored in the configuration/org.codesearch.org.eclipse.update/platform.xml file.
...
public class PlatformConfiguration implements IPlatformConfiguration, IConfigurationConstants {
	...
	private static final String DEFAULT_FEATURE_APPLICATION = "org.codesearch.org.eclipse.ui.ide.workbench"; //$NON-NLS-1$
	...
	PlatformConfiguration(URL url) throws Exception {
		...
		try {
			if (url.getProtocol().equals("file")) {
				if (url.getPath().endsWith("configuration/org.codesearch.org.eclipse.update/platform.xml"))
