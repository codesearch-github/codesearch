 ...
 * exist:
 * <ul>
 * <li> {@link org.codesearch.org.eclipse.jface.text.IDocumentPartitioningListenerExtension} since version 2.0 replacing the original
 *      notification mechanism.</li>
 * <li> {@link org.codesearch.org.eclipse.jface.text.IDocumentPartitioningListenerExtension2} since version 3.0 replacing all previous
 *      notification mechanisms. Thus, implementers up-to-date with version 3.0 do not have to implement
 *      {@link org.codesearch.org.eclipse.jface.text.IDocumentPartitioningListenerExtension}.</li>
 * </ul>
 * </p>
 * @see org.codesearch.org.eclipse.jface.text.IDocumentPartitioningListenerExtension
 * @see org.codesearch.org.eclipse.jface.text.IDocumentPartitioningListenerExtension2
