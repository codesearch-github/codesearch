 ...
 * 
 * @since org.codesearch.org.eclipse.equinox.registry 3.2.100
 */
public class EquinoxUtils {
	...
	public static ServiceRegistration registerCommandProvider(BundleContext context) {
		...
		try {
			...
			return context.registerService("org.codesearch.org.eclipse.osgi.framework.console.CommandProvider", new RegistryCommandProvider(), null); //$NON-NLS-1$
