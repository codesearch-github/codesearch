 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.osgi.internal.composite;

import java.io.IOException;
import java.io.InputStream;
import org.codesearch.org.eclipse.osgi.framework.adaptor.BundleData;
import org.codesearch.org.eclipse.osgi.framework.adaptor.ClassLoaderDelegate;
import org.codesearch.org.eclipse.osgi.framework.internal.core.BundleHost;
import org.codesearch.org.eclipse.osgi.internal.module.CompositeResolveHelper;
import org.codesearch.org.eclipse.osgi.service.internal.composite.CompositeModule;
...
public abstract class CompositeBase extends BundleHost implements CompositeResolveHelper, CompositeModule {
	protected static String PROP_COMPOSITE = "org.codesearch.org.eclipse.equinox.Composite"; //$NON-NLS-1$
	protected static String PROP_PARENTFRAMEWORK = "org.codesearch.org.eclipse.equinox.parentFramework"; //$NON-NLS-1$

	protected final Framework companionFramework;
	protected final ThreadLocal resolving = new ThreadLocal();

	public CompositeBase(BundleData bundledata, org.codesearch.org.eclipse.osgi.framework.internal.core.Framework framework) throws BundleException {
	 ...
	 */
	protected abstract Framework findCompanionFramework(org.codesearch.org.eclipse.osgi.framework.internal.core.Framework thisFramework, BundleData thisData) throws BundleException;
