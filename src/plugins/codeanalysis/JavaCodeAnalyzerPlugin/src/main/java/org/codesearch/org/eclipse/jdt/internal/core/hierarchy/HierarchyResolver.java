...
import org.codesearch.org.eclipse.jdt.internal.compiler.env.IGenericType;
...
public void accept(ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction) {
	...
	if (unit != null) {
		try {
			...
			org.codesearch.org.eclipse.jdt.core.ICompilationUnit cu = ((SourceTypeElementInfo)sourceType).getHandle().getCompilationUnit();
 ...
 */
private void rememberAllTypes(CompilationUnitDeclaration parsedUnit, org.codesearch.org.eclipse.jdt.core.ICompilationUnit cu, boolean includeLocalTypes) {
...
public void resolve(IGenericType suppliedType) {
	try {
		if (suppliedType.isBinaryType()) {
			...
			org.codesearch.org.eclipse.jdt.core.ICompilationUnit cu = ((SourceTypeElementInfo)suppliedType).getHandle().getCompilationUnit();
...
public void resolve(Openable[] openables, HashSet localTypes, IProgressMonitor monitor) {
	try {
		...
		org.codesearch.org.eclipse.jdt.core.ICompilationUnit[] cus = new org.codesearch.org.eclipse.jdt.core.ICompilationUnit[openablesLength];
		int unitsIndex = 0;
		...
		for (int i = 0; i < openablesLength; i++) {
			...
			if (openable instanceof org.codesearch.org.eclipse.jdt.core.ICompilationUnit) {
				org.codesearch.org.eclipse.jdt.core.ICompilationUnit cu = (org.codesearch.org.eclipse.jdt.core.ICompilationUnit)openable;
