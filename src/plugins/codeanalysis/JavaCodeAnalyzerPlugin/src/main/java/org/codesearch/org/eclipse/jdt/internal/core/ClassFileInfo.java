...
import org.codesearch.org.eclipse.jdt.internal.compiler.env.IBinaryField;
import org.codesearch.org.eclipse.jdt.internal.compiler.env.IBinaryMethod;
import org.codesearch.org.eclipse.jdt.internal.compiler.env.IBinaryNestedType;
...
private void generateAnnotationInfo(JavaElement parent, HashMap newElements, IBinaryAnnotation annotationInfo, String memberValuePairName) {
	char[] typeName = org.codesearch.org.eclipse.jdt.core.Signature.toCharArray(CharOperation.replaceOnCopy(annotationInfo.getTypeName(), '/', '.'));
