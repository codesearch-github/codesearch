 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.core.internal.expressions;

import java.util.HashMap;
import java.util.Map;

import org.codesearch.org.eclipse.core.expressions.Expression;
import org.codesearch.org.eclipse.core.expressions.ExpressionConverter;
...
import org.codesearch.org.eclipse.core.runtime.IExtensionDelta;
import org.codesearch.org.eclipse.core.runtime.IExtensionRegistry;
import org.codesearch.org.eclipse.core.runtime.IRegistryChangeEvent;
import org.codesearch.org.eclipse.core.runtime.IRegistryChangeListener;
import org.codesearch.org.eclipse.core.runtime.InvalidRegistryObjectException;
...
public class DefinitionRegistry implements IRegistryChangeListener {
	...
	public DefinitionRegistry() {
		Platform.getExtensionRegistry().addRegistryChangeListener(this, "org.codesearch.org.eclipse.core.expressions"); //$NON-NLS-1$
	}
	...
	public Expression getExpression(String id) throws CoreException {
		...
		IConfigurationElement[] ces= registry.getConfigurationElementsFor("org.codesearch.org.eclipse.core.expressions", "definitions"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void registryChanged(IRegistryChangeEvent event) {
		IExtensionDelta[] extensionDeltas= event.getExtensionDeltas("org.codesearch.org.eclipse.core.expressions", "definitions"); //$NON-NLS-1$//$NON-NLS-2$
