...
public abstract class FileTree implements IFileTree {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.filesystem.IFileTree#getChildrenFileInfos(org.codesearch.org.eclipse.core.filesystem.IFileStore)
	 */
	public abstract IFileInfo[] getChildInfos(IFileStore store);

	/*(non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.filesystem.IFileTree#getFileInfo(org.codesearch.org.eclipse.core.filesystem.IFileStore)
	 */
	public abstract IFileInfo getFileInfo(IFileStore store);

	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.filesystem.IFileTree#getChildrenFileStores(org.codesearch.org.eclipse.core.filesystem.IFileStore)
	 */
