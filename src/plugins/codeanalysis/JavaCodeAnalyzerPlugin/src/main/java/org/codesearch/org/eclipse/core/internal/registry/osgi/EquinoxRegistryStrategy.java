...
public class EquinoxRegistryStrategy extends RegistryStrategyOSGI {
	...
	public static final String PLUGIN_NAME = "org.codesearch.org.eclipse.equinox.registry"; //$NON-NLS-1$
	...
	public long getContainerTimestamp() {
		...
		ServiceReference ref = context.getServiceReference("org.codesearch.org.eclipse.osgi.service.resolver.PlatformAdmin"); //$NON-NLS-1$
		if (ref == null)
			return -1;
