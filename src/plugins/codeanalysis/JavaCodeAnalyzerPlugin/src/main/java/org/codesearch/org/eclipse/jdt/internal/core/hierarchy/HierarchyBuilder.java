...
import org.codesearch.org.eclipse.jdt.internal.core.util.ResourceCompilationUnit;
...
public abstract class HierarchyBuilder {
	...
	public HierarchyBuilder(TypeHierarchy hierarchy) throws JavaModelException {
		...
		org.codesearch.org.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType == null ? null : focusType.getCompilationUnit();
		org.codesearch.org.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.hierarchy.workingCopies;
		org.codesearch.org.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside;
...
protected IBinaryType createInfoFromClassFile(Openable handle, IResource file) {
	...
	} catch (org.codesearch.org.eclipse.jdt.internal.compiler.classfmt.ClassFormatException e) {
		if (TypeHierarchy.DEBUG) {
			e.printStackTrace();
		}
		return null;
...
protected IBinaryType createInfoFromClassFileInJar(Openable classFile) {
	...
	try {
		...
		info = org.codesearch.org.eclipse.jdt.internal.compiler.classfmt.ClassFileReader.read(
			zipFile,
			classFilePath);
	} catch (org.codesearch.org.eclipse.jdt.internal.compiler.classfmt.ClassFormatException e) {
		if (TypeHierarchy.DEBUG) {
