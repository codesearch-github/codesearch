...
public class PreferenceServiceRegistryHelper implements IRegistryChangeListener {
	...
	private IExtension[] getPrefExtensions() {
		...
		if (extensions.length == 0) {
			if (EclipsePreferences.DEBUG_PREFERENCE_GENERAL)
				PrefsMessages.message("No extensions for org.codesearch.org.eclipse.core.contenttype."); //$NON-NLS-1$
		}
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.runtime.IRegistryChangeListener#registryChanged(org.codesearch.org.eclipse.core.runtime.IRegistryChangeEvent)
	 */
