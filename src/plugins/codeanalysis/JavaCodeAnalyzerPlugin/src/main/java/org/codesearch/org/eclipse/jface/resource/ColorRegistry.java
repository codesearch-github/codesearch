...
public class ColorRegistry extends ResourceRegistry {
     ...
     * value type: <code>org.codesearch.org.eclipse.swt.graphics.Color</code>.
     */
    private Map stringToColor = new HashMap(7);

    /**
     * Table of known color data, keyed by symbolic color name (key type:
     * <code>String</code>, value type: <code>org.codesearch.org.eclipse.swt.graphics.RGB</code>).
     */
     ...
     * display.
     * 
     * @see org.codesearch.org.eclipse.swt.widgets.Display#getCurrent()
     */
