 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.swt.widgets;


import org.codesearch.org.eclipse.swt.*;
import org.codesearch.org.eclipse.swt.internal.*;
import org.codesearch.org.eclipse.swt.internal.gtk.*;
import org.codesearch.org.eclipse.swt.graphics.*;
...
public class Display extends Device {
	...
	static final String DISPATCH_EVENT_KEY = "org.codesearch.org.eclipse.swt.internal.gtk.dispatchEvent"; //$NON-NLS-1$
	static final String ADD_WIDGET_KEY = "org.codesearch.org.eclipse.swt.internal.addWidget"; //$NON-NLS-1$
	long /*int*/ [] closures;
	int [] signalIds;
	...
	Shell [] modalShells;
	Dialog modalDialog;
	static final String GET_MODAL_DIALOG = "org.codesearch.org.eclipse.swt.internal.gtk.getModalDialog"; //$NON-NLS-1$
	static final String SET_MODAL_DIALOG = "org.codesearch.org.eclipse.swt.internal.gtk.setModalDialog"; //$NON-NLS-1$
	...
	static final String ADD_IDLE_PROC_KEY = "org.codesearch.org.eclipse.swt.internal.gtk.addIdleProc"; //$NON-NLS-1$
	static final String REMOVE_IDLE_PROC_KEY = "org.codesearch.org.eclipse.swt.internal.gtk.removeIdleProc"; //$NON-NLS-1$
	...
	static final String GET_DIRECTION_PROC_KEY = "org.codesearch.org.eclipse.swt.internal.gtk.getDirectionProc"; //$NON-NLS-1$
	
	/* Set emissionProc callback */
	long /*int*/ emissionProc;
	Callback emissionProcCallback;
	static final String GET_EMISSION_PROC_KEY = "org.codesearch.org.eclipse.swt.internal.gtk.getEmissionProc"; //$NON-NLS-1$
...
//		{OS.GDK_????,		SWT.COMMAND},
	...
	/* Package name */
	static final String PACKAGE_PREFIX = "org.codesearch.org.eclipse.swt.widgets."; //$NON-NLS-1$
	...
	switch((int)/*64*/user_data) {
		...
		case PROPERTY_NOTIFY:
			...
			if (gdkEvent.type == OS.GDK_PROPERTY_NOTIFY) {
				byte[] name = Converter.wcsToMbcs (null, "org.codesearch.org.eclipse.swt.filePath.message", true); //$NON-NLS-1$
