 ...
 * @see org.codesearch.org.eclipse.jdt.internal.core.search.matching.PatternLocator#updateMatch(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding, char[][][], org.codesearch.org.eclipse.jdt.internal.core.search.matching.MatchLocator)
 *
 */
...
protected void reportDeclaration(FieldBinding fieldBinding, MatchLocator locator, SimpleSet knownFields) throws CoreException {
	...
	if (isBinary) {
		...
		info = locator.getBinaryInfo((org.codesearch.org.eclipse.jdt.internal.core.ClassFile) type.getClassFile(), resource);
