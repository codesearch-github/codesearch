...
public class FileModificationValidationContext {
	...
	/**
	 * Constant that can be passed to {@link IWorkspace#validateEdit(org.codesearch.org.eclipse.core.resources.IFile[], Object)}
	...
	/**
	 * Return the <code>org.codesearch.org.eclipse.swt.widgets.Shell</code> that is to be used to
