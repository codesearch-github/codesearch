 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.core.runtime.internal.stats;

import java.io.*;
import java.net.URL;
import java.util.*;
import org.codesearch.org.eclipse.osgi.baseadaptor.HookConfigurator;
import org.codesearch.org.eclipse.osgi.baseadaptor.HookRegistry;
...
import org.codesearch.org.eclipse.osgi.framework.adaptor.BundleWatcher;
...
public class StatsManager implements BundleWatcher, HookConfigurator, ClassLoadingStatsHook {
	...
	public static final String FRAMEWORK_SYMBOLICNAME = "org.codesearch.org.eclipse.osgi"; //$NON-NLS-1$
