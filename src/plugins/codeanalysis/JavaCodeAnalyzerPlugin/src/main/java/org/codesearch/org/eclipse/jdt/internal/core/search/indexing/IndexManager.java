...
import org.codesearch.org.eclipse.jdt.internal.core.index.*;
import org.codesearch.org.eclipse.jdt.internal.core.search.BasicSearchEngine;
import org.codesearch.org.eclipse.jdt.internal.core.search.PatternSearchJob;
import org.codesearch.org.eclipse.jdt.internal.core.search.processing.IJob;
...
private char[][] readJavaLikeNamesFile() {
	try {
		...
		if (!javaLikeNamesFile.exists())
			return null;
		char[] javaLikeNames = org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(javaLikeNamesFile, null);
...
private char[][] readIndexState(String dirOSString) {
	try {
		char[] savedIndexNames = org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(this.savedIndexNamesFile, null);
...
private void readParticipantsIndexNamesFile() {
	...
	try {
		char[] participantIndexNames = org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(this.participantIndexNamesFile, null);
