					...
					new IResourceProxyVisitor() {
						public boolean visit(IResourceProxy proxy) throws CoreException {
							if (proxy.getType() == IResource.FILE) {
								if (org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(proxy.getName())) {
				...
				switch(proxy.getType()) {
					case IResource.FILE :
						if (org.codesearch.org.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(proxy.getName()) ||
							org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(proxy.getName())) return false;
