...
import org.codesearch.org.eclipse.jdt.core.dom.BindingResolver;
...
class DefaultValuePairBinding extends MemberValuePairBinding {
	...
	private org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding method;

	DefaultValuePairBinding(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding binding, BindingResolver resolver) {
		super(null, resolver);
		this.method = binding;
