...
import org.codesearch.org.eclipse.core.runtime.preferences.ConfigurationScope;
...
public class OSGiPreferencesServiceManager implements ServiceFactory, BundleListener {
	...
	private static final String ORG_ECLIPSE_CORE_INTERNAL_PREFERENCES_OSGI = "org.codesearch.org.eclipse.core.internal.preferences.osgi"; //$NON-NLS-1$
	...
	private String getQualifier(Bundle bundle) {
		String qualifier = "org.codesearch.org.eclipse.core.runtime.preferences.OSGiPreferences." + bundle.getBundleId(); //$NON-NLS-1$		
		return qualifier;
	}
