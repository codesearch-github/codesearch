...
public class CommentRecorderParser extends Parser {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#consumeClassHeader()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#consumeEmptyTypeDeclaration()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#consumeInterfaceHeader()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#endParse(int)
	 */
	 ...
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#flushCommentsDefinedPriorTo(int)
	 */
	public int flushCommentsDefinedPriorTo(int position) {
		...
		if (validCount > 0){
			...
			while (index<lastCommentIndex && (immediateCommentEnd = -this.scanner.commentStops[index+1])  > 0){ // only tolerating non-javadoc comments (non-javadoc comment end positions are negative)
				...
				if (org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0, this.scanner.linePtr)
						!= org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getLineNumber(immediateCommentEnd, this.scanner.lineEnds, 0, this.scanner.linePtr)) break;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#initialize()
	 */
	 ...
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#initializeScanner()
	 */
	...
	/* (non-Javadoc)
	 * Save all source comments currently stored before flushing them.
	 * @see org.codesearch.org.eclipse.jdt.internal.compiler.parser.Parser#resetModifiers()
	 */
