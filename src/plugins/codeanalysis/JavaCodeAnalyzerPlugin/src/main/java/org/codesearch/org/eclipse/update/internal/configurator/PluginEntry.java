...
public class PluginEntry {
	...
	/**
	 * @return url relative to the site location: plugins/org.codesearch.org.eclipse.foo/plugin.xml
	 * Note: to do: we should probably only use plugins/org.codesearch.org.eclipse.foo/ in the future
	 */
