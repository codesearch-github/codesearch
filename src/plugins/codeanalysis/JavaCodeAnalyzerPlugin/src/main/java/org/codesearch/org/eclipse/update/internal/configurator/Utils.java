...
public class Utils {
	...
	private static final String PI_OSGI = "org.codesearch.org.eclipse.osgi"; //$NON-NLS-1$
	...
	public static CoreException newCoreException(String s, Throwable e) {
		...
		if (e instanceof CoreException) {
			if (s == null)
				s = ""; //$NON-NLS-1$
			status = new MultiStatus("org.codesearch.org.eclipse.update.configurator", 0, s, e); //$NON-NLS-1$
	...
	public static IStatus newStatus(String message, Throwable e) {
		return new Status(IStatus.ERROR, "org.codesearch.org.eclipse.update.configurator", IStatus.OK, message, e); //$NON-NLS-1$
	}
	...
	public static boolean isAutomaticallyStartedBundle(String bundleURL) {
		if (bundleURL.indexOf("org.codesearch.org.eclipse.osgi") != -1) //$NON-NLS-1$
			return true;
