...
public class CompatibilityHelper {
	...
	public static final String PI_RUNTIME_COMPATIBILITY = "org.codesearch.org.eclipse.core.runtime.compatibility"; //$NON-NLS-1$
	...
	public synchronized static Bundle initializeCompatibility() {
		...
		if (compatibility == null || (compatibility.getState() & (Bundle.INSTALLED | Bundle.UNINSTALLED | Bundle.STOPPING)) != 0)
			compatibility = org.codesearch.org.eclipse.core.internal.runtime.InternalPlatform.getDefault().getBundle(PI_RUNTIME_COMPATIBILITY);
