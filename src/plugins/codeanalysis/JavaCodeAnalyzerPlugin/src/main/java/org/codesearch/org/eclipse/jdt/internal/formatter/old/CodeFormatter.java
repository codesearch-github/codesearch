 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jdt.internal.formatter.old;
 ...
 * @deprecated
*/
public class CodeFormatter implements TerminalTokens, org.codesearch.org.eclipse.jdt.core.ICodeFormatter {
	...
	public String format(String string, int indentLevel, int[] positions, String lineSeparator) {
		...
		TextEdit textEdit = defaultCodeFormatter.format(org.codesearch.org.eclipse.jdt.core.formatter.CodeFormatter.K_UNKNOWN, string, 0, string.length(), indentLevel, lineSeparator);
		...
		return org.codesearch.org.eclipse.jdt.internal.core.util.Util.editedString(string, textEdit);
	}
}
