 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.core.boot;

import java.io.IOException;
import java.net.URL;
import org.codesearch.org.eclipse.core.internal.boot.PlatformConfiguration;
import org.codesearch.org.eclipse.core.internal.runtime.InternalPlatform;
import org.codesearch.org.eclipse.core.runtime.Platform;
import org.codesearch.org.eclipse.update.configurator.IPlatformConfiguration;
import org.codesearch.org.eclipse.update.configurator.IPlatformConfigurationFactory;
...
public final class BootLoader {
	...
	/**
	 * The unique identifier constant (value "<code>org.codesearch.org.eclipse.core.boot</code>")
	 * of the Core Boot (pseudo-) plug-in.
	 */
	public static final String PI_BOOT = "org.codesearch.org.eclipse.core.boot"; //$NON-NLS-1$
	 ...
	 */
	public static org.codesearch.org.eclipse.core.boot.IPlatformConfiguration getCurrentPlatformConfiguration() {
	 ...
	 * @deprecated This functionality has moved to the Eclipse Update manager plug-in.
	 */
	public static org.codesearch.org.eclipse.core.boot.IPlatformConfiguration getPlatformConfiguration(URL url) throws IOException {
		BundleContext context = InternalPlatform.getDefault().getBundleContext();
		// acquire factory service first
		ServiceReference configFactorySR = context.getServiceReference(IPlatformConfigurationFactory.class.getName());
		if (configFactorySR == null)
	 ...
	 *		extension point (i.e., <code>org.codesearch.org.eclipse.core.applications</code>).
	 ...
	 * non-API methods on <code>org.codesearch.org.eclipse.core.runtime.adaptor.EclipseStarter</code>
	 * in the org.codesearch.org.eclipse.osgi plug-in.
	 */
	 ...
	 *		extension-point (i.e., <code>org.codesearch.org.eclipse.core.runtime.applications</code>).
