...
import org.codesearch.org.eclipse.core.expressions.IPropertyTester;
...
public class TypeExtensionManager implements IRegistryChangeListener {
	 ...
	 * @since 3.5
	 */
	private static boolean DEBUG= "true".equalsIgnoreCase(Platform.getDebugOption("org.codesearch.org.eclipse.core.expressions/debug/TypeExtensionManager")); //$NON-NLS-1$//$NON-NLS-2$
