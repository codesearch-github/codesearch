 ...
 * list includes <code>org.codesearch.org.eclipse.core.runtime</code>, the default constructor of the plug-in 
 ...
 * <code>org.codesearch.org.eclipse.core.runtime.compatibility</code>, the {@link #Plugin(IPluginDescriptor)}
...
public abstract class Plugin implements BundleActivator {
	 ...
	 * match the InstanceScope's variable SCOPE from org.codesearch.org.eclipse.core.runtime.preferences.
	 ...
	 * needed/used if this plug-in requires the org.codesearch.org.eclipse.core.runtime.compatibility plug-in.  
	 ...
	 * which explicitly require the org.codesearch.org.eclipse.core.runtime.compatibility plug-in.
	 */
	...
	public final Preferences getPluginPreferences() {
		...
		Runnable innerCall = new Runnable() {
			public void run() {
				preferencesCopy[0] = new org.codesearch.org.eclipse.core.internal.preferences.legacy.PreferenceForwarder(this, bundleCopy.getSymbolicName());
			}
		};
		innerCall.run();
	...
	public final void savePluginPreferences() {
		...
		Runnable innerCall = new Runnable() {
			public void run() {
				try {
					((org.codesearch.org.eclipse.core.internal.preferences.legacy.PreferenceForwarder) preferencesCopy).flush();
	 ...
	 * {@link org.codesearch.org.eclipse.core.runtime.preferences.AbstractPreferenceInitializer}. 
	 * This class should be contributed via the
	 * <code>org.codesearch.org.eclipse.core.runtime.preferences</code> extension point.
	 * <pre>
	 * 	&lt;extension point=&quo;org.codesearch.org.eclipse.core.runtime.preferences&quo;&gt;
	 ...
	 * org.codesearch.org.eclipse.core.runtime.compatibility plug-in.
	 */
