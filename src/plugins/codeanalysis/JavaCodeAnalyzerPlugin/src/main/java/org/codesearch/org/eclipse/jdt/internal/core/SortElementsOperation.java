...
import org.codesearch.org.eclipse.jdt.core.dom.rewrite.ASTRewrite;
import org.codesearch.org.eclipse.jdt.core.dom.rewrite.ListRewrite;
import org.codesearch.org.eclipse.jdt.core.util.CompilationUnitSorter;
...
import org.codesearch.org.eclipse.jface.text.Document;
...
public class SortElementsOperation extends JavaModelOperation {
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.internal.core.JavaModelOperation#executeOperation()
	 */
	 ...
	 */
	public TextEdit calculateEdit(org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit unit, TextEditGroup group) throws JavaModelException {
	...
	private String processElement(ICompilationUnit unit, char[] source) {
		...
		org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit ast = (org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit) parser.createAST(null);
	...
	private ASTRewrite sortCompilationUnit(org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit ast, final TextEditGroup group) {
		ast.accept(new ASTVisitor() {
			public boolean visit(org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
		...
		ast.accept(new ASTVisitor() {
			...
			public boolean visit(org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
				...
				sortElements(compilationUnit.types(), rewriter.getListRewrite(compilationUnit, org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit.TYPES_PROPERTY));
				return true;
			}
