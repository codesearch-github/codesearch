...
import java.util.*;
import org.codesearch.org.eclipse.core.internal.localstore.PrefixPool;
...
public class RefreshJob extends WorkspaceJob {
	...
	/* (non-Javadoc)
	 *  @see org.codesearch.org.eclipse.core.runtime.jobs.Job#belongsTo(Object)
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.resources.refresh.IRefreshResult#refresh
	 */
