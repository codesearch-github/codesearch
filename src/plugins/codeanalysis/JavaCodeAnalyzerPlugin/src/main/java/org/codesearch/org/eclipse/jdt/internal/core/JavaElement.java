...
import org.codesearch.org.eclipse.jdt.core.ISourceReference;
...
//	private static final QualifiedName PROJECT_JAVADOC= new QualifiedName(JavaCore.PLUGIN_ID, "project_javadoc_location"); //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.IJavaElement#getSchedulingRule()
	 */
	...
	protected String getURLContents(String docUrlValue) throws JavaModelException {
		...
		try {
			...
			byte[] contents = org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsByteArray(stream, connection.getContentLength());
			if (encoding == null) {
					...
					if (index != -1) {
						...
						if (index2 != -1) {
							...
							if (charsetIndex != -1) {
								...
								encoding = new String(contents, start, index2 - start, org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.UTF_8);
							}
						}
					}
				}
