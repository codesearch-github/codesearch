...
import org.codesearch.org.eclipse.jdt.internal.compiler.batch.Main;
...
import org.codesearch.org.eclipse.jdt.internal.core.util.RecordedParsingInformation;
...
public class ASTParser {
	...
	private List getClasspath() throws IllegalStateException {
		...
		try {
			if ((this.bits & CompilationUnitResolver.INCLUDE_RUNNING_VM_BOOTCLASSPATH) != 0) {
				org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.collectRunningVMBootclasspath(allClasspaths);
			}
	 ...
	 * </p>
	 * <p>Note that working copy owner are used only if the <code>org.codesearch.org.eclipse.jdt.core</code>
		...
		switch(this.astKind) {
				...
				if (this.rawSource == null) {
					if (this.typeRoot != null) {
						...
						if (this.typeRoot instanceof ICompilationUnit) {
							org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = (org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
			...
			case K_COMPILATION_UNIT :
				...
				try {
					...
					org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = null;
					WorkingCopyOwner wcOwner = this.workingCopyOwner;
					if (this.typeRoot instanceof ICompilationUnit) {
							/*
							 * this.compilationUnitSource is an instance of org.codesearch.org.eclipse.jdt.internal.core.CompilationUnit that implements
							 * both org.codesearch.org.eclipse.jdt.core.ICompilationUnit and org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit
							 */
							sourceUnit = (org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
							/*
	...
	private ASTNode internalCreateASTForKind() {
		...
		switch(this.astKind) {
			case K_STATEMENTS :
				...
				org.codesearch.org.eclipse.jdt.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
				if (statements != null) {
				...
				return block;
			case K_EXPRESSION :
				org.codesearch.org.eclipse.jdt.internal.compiler.ast.Expression expression = codeSnippetParsingUtil.parseExpression(this.rawSource, this.sourceOffset, this.sourceLength, this.compilerOptions, true);
			...
			case K_CLASS_BODY_DECLARATIONS :
				final org.codesearch.org.eclipse.jdt.internal.compiler.ast.ASTNode[] nodes =
