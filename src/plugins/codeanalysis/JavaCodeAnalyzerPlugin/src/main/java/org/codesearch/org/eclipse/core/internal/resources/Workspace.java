...
import org.codesearch.org.eclipse.core.internal.events.*;
...
import org.codesearch.org.eclipse.core.internal.refresh.RefreshManager;
...
import org.codesearch.org.eclipse.core.resources.team.*;
...
public class Workspace extends PlatformObject implements IWorkspace, ICoreConstants {
	...
	private boolean canCreateExtensions() {
		return Platform.getBundle("org.codesearch.org.eclipse.osgi").getState() != Bundle.STOPPING; //$NON-NLS-1$
	}
	...
	URI toURI(IPath path) {
		if (path.isAbsolute())
			return org.codesearch.org.eclipse.core.filesystem.URIUtil.toURI(path);
		try {
	...
	/*
	 * (non-Javadoc)
	 * @see org.codesearch.org.eclipse.core.resources.IWorkspace#validateProjectLocation(org.codesearch.org.eclipse.core.resources.IProject, java.net.URI)
	 */
