...
public class Debug {
	 ...
	 */
	public static final String ECLIPSE_OSGI = "org.codesearch.org.eclipse.osgi"; //$NON-NLS-1$
	/**
	...
	static {
		...
		if (dbgOptions != null) {
			...
			DEBUG_BUNDLE_TIME = dbgOptions.getBooleanOption(OPTION_DEBUG_BUNDLE_TIME, false) || dbgOptions.getBooleanOption("org.codesearch.org.eclipse.core.runtime/timing/startup", false); //$NON-NLS-1$
			...
			DEBUG_PACKAGEADMIN_TIMING = dbgOptions.getBooleanOption(OPTION_DEBUG_PACKAGEADMIN_TIMING, false) || dbgOptions.getBooleanOption("org.codesearch.org.eclipse.core.runtime/debug", false); //$NON-NLS-1$
