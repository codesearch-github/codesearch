 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.core.internal.boot;

import java.io.IOException;
import java.net.URL;
import org.codesearch.org.eclipse.core.boot.IPlatformConfiguration;

public class PlatformConfiguration implements IPlatformConfiguration {
	private org.codesearch.org.eclipse.update.configurator.IPlatformConfiguration newConfig;

	public PlatformConfiguration(org.codesearch.org.eclipse.update.configurator.IPlatformConfiguration config) {
		newConfig = config;
	}
	...
	public ISiteEntry[] getConfiguredSites() {
		org.codesearch.org.eclipse.update.configurator.IPlatformConfiguration.ISiteEntry[] sites = newConfig.getConfiguredSites();
	...
	public ISiteEntry findConfiguredSite(URL url) {
		org.codesearch.org.eclipse.update.configurator.IPlatformConfiguration.ISiteEntry siteEntry = newConfig.findConfiguredSite(url);
		if (siteEntry == null)
			return null;
	...
	public IFeatureEntry[] getConfiguredFeatureEntries() {
		org.codesearch.org.eclipse.update.configurator.IPlatformConfiguration.IFeatureEntry[] entries = newConfig.getConfiguredFeatureEntries();
