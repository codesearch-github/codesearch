 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jdt.internal.eval;
...
import org.codesearch.org.eclipse.jdt.internal.codeassist.ISelectionRequestor;
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext
 */
...
public EvaluationContext() {
	...
	this.lineSeparator = org.codesearch.org.eclipse.jdt.internal.compiler.util.Util.LINE_SEPARATOR; // default value
}
/**
...
/**
 * @see org.codesearch.org.eclipse.jdt.core.eval.IEvaluationContext
 * @exception org.codesearch.org.eclipse.jdt.internal.eval.InstallException if the code snippet class files could not be deployed.
 */
...
writer.write(org.codesearch.org.eclipse.jdt.internal.eval.EvaluationContext.getCodeSnippetSource());
writer.close();
org.codesearch.org.eclipse.jdt.internal.compiler.batch.Main.compile(
	"d:/temp/CodeSnippet.java -d d:/temp -classpath d:/jdk1.2.2/jre/lib/rt.jar -verbose");
java.io.FileInputStream reader =  new java.io.FileInputStream("d:/temp/org.codesearch.org.eclipse/jdt/internal/eval/target/CodeSnippet.class");
byte[] bytes = org.codesearch.org.eclipse.jdt.internal.core.Util.readContentsAsBytes(reader);
reader.close();
...
public static String getCodeSnippetSource() {
	return
		"package org.codesearch.org.eclipse.jdt.internal.eval.target;\n" + //$NON-NLS-1$
		"\n" + //$NON-NLS-1$
		"/*\n" + //$NON-NLS-1$
...
/**
 * Return the binary for the root code snippet class (i.e. org.codesearch.org.eclipse.jdt.internal.eval.target.CodeSnippet).
 */
 ...
 *
 *  @param environment org.codesearch.org.eclipse.jdt.internal.core.SearchableEnvironment
 *      used to resolve type/package references and search for types/packages
 *      based on partial names.
 *
