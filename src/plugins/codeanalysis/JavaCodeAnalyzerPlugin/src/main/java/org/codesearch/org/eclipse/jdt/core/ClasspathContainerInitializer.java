...
import org.codesearch.org.eclipse.jdt.internal.core.JavaModelStatus;
 ...
 * "org.codesearch.org.eclipse.jdt.core.classpathContainerInitializer" extension point.
 * <p>
...
public abstract class ClasspathContainerInitializer {
   ...
   /**
	 ...
	 * <ul>
	 * <li>{@link JavaCore#setClasspathContainer(IPath, IJavaProject[], IClasspathContainer[], org.codesearch.org.eclipse.core.runtime.IProgressMonitor)}</li>
	 * <li>{@link JavaCore#getClasspathContainer(IPath, IJavaProject)}</li>
	 * <li>{@link JavaCore#create(org.codesearch.org.eclipse.core.resources.IWorkspaceRoot)}</li>
	 * <li>{@link JavaCore#create(org.codesearch.org.eclipse.core.resources.IProject)}</li>
     ...
     * @see JavaCore#setClasspathContainer(IPath, IJavaProject[], IClasspathContainer[], org.codesearch.org.eclipse.core.runtime.IProgressMonitor)
     * @see IClasspathContainer
     */
