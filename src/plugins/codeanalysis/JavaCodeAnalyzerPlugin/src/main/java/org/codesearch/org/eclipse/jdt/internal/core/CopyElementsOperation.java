		...
		switch (element.getElementType()) {
			...
			case IJavaElement.TYPE :
				if (isRenamingMainType(element, dest)) {
					...
					String lineSeparator = org.codesearch.org.eclipse.jdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
			...
			case IJavaElement.FIELD :
				...
				lineSeparator = org.codesearch.org.eclipse.jdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
...
protected boolean isRenamingMainType(IJavaElement element, IJavaElement dest) throws JavaModelException {
	if ((isRename() || getNewNameFor(element) != null)
		...
		typeName = org.codesearch.org.eclipse.jdt.internal.core.util.Util.getNameWithoutJavaLikeExtension(typeName);
