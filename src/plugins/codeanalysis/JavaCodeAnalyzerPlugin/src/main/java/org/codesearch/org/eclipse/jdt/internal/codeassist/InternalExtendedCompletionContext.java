...
import org.codesearch.org.eclipse.jdt.internal.codeassist.complete.CompletionNodeDetector;
import org.codesearch.org.eclipse.jdt.internal.codeassist.complete.CompletionParser;
import org.codesearch.org.eclipse.jdt.internal.codeassist.impl.AssistCompilationUnit;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.BinaryTypeBinding;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ImportBinding;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.SignatureWrapper;
...
import org.codesearch.org.eclipse.jdt.internal.core.CompilationUnitElementInfo;
...
public class InternalExtendedCompletionContext {
	...
	private void computeEnclosingJavaElements() {
		...
		if (this.typeRoot.getElementType() == IJavaElement.COMPILATION_UNIT) {
	 		ICompilationUnit original = (org.codesearch.org.eclipse.jdt.core.ICompilationUnit)this.typeRoot;
			...
			org.codesearch.org.eclipse.jdt.core.ICompilationUnit handle = new AssistCompilationUnit(original, this.owner, handleToBinding, handleToInfo);
