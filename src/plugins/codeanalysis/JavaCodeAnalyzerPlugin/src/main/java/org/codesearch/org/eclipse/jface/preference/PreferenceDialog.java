 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jface.preference;
...
import org.codesearch.org.eclipse.core.runtime.IStatus;
import org.codesearch.org.eclipse.core.runtime.ListenerList;
import org.codesearch.org.eclipse.core.runtime.SafeRunner;
import org.codesearch.org.eclipse.core.runtime.Status;
import org.codesearch.org.eclipse.jface.dialogs.DialogMessageArea;
import org.codesearch.org.eclipse.jface.dialogs.IDialogConstants;
import org.codesearch.org.eclipse.jface.dialogs.IMessageProvider;
import org.codesearch.org.eclipse.jface.dialogs.IPageChangeProvider;
import org.codesearch.org.eclipse.jface.dialogs.IPageChangedListener;
import org.codesearch.org.eclipse.jface.dialogs.MessageDialog;
import org.codesearch.org.eclipse.jface.dialogs.PageChangedEvent;
import org.codesearch.org.eclipse.jface.dialogs.TrayDialog;
import org.codesearch.org.eclipse.jface.resource.JFaceResources;
import org.codesearch.org.eclipse.jface.util.IPropertyChangeListener;
import org.codesearch.org.eclipse.jface.util.Policy;
import org.codesearch.org.eclipse.jface.util.PropertyChangeEvent;
import org.codesearch.org.eclipse.jface.util.SafeRunnable;
import org.codesearch.org.eclipse.jface.viewers.ISelection;
import org.codesearch.org.eclipse.jface.viewers.ISelectionChangedListener;
import org.codesearch.org.eclipse.jface.viewers.IStructuredSelection;
import org.codesearch.org.eclipse.jface.viewers.SelectionChangedEvent;
import org.codesearch.org.eclipse.jface.viewers.StructuredSelection;
import org.codesearch.org.eclipse.jface.viewers.TreeViewer;
import org.codesearch.org.eclipse.jface.viewers.ViewerComparator;
import org.codesearch.org.eclipse.jface.viewers.ViewerFilter;
import org.codesearch.org.eclipse.swt.SWT;
import org.codesearch.org.eclipse.swt.custom.BusyIndicator;
import org.codesearch.org.eclipse.swt.custom.ScrolledComposite;
import org.codesearch.org.eclipse.swt.events.ControlAdapter;
import org.codesearch.org.eclipse.swt.events.ControlEvent;
import org.codesearch.org.eclipse.swt.events.DisposeEvent;
import org.codesearch.org.eclipse.swt.events.DisposeListener;
import org.codesearch.org.eclipse.swt.events.HelpEvent;
import org.codesearch.org.eclipse.swt.events.HelpListener;
import org.codesearch.org.eclipse.swt.events.SelectionAdapter;
import org.codesearch.org.eclipse.swt.events.SelectionEvent;
import org.codesearch.org.eclipse.swt.events.ShellAdapter;
import org.codesearch.org.eclipse.swt.events.ShellEvent;
import org.codesearch.org.eclipse.swt.graphics.Font;
import org.codesearch.org.eclipse.swt.graphics.Point;
import org.codesearch.org.eclipse.swt.graphics.Rectangle;
import org.codesearch.org.eclipse.swt.layout.FormAttachment;
import org.codesearch.org.eclipse.swt.layout.FormData;
import org.codesearch.org.eclipse.swt.layout.FormLayout;
import org.codesearch.org.eclipse.swt.layout.GridData;
import org.codesearch.org.eclipse.swt.layout.GridLayout;
import org.codesearch.org.eclipse.swt.widgets.Button;
import org.codesearch.org.eclipse.swt.widgets.Composite;
import org.codesearch.org.eclipse.swt.widgets.Control;
import org.codesearch.org.eclipse.swt.widgets.Event;
import org.codesearch.org.eclipse.swt.widgets.Label;
import org.codesearch.org.eclipse.swt.widgets.Layout;
import org.codesearch.org.eclipse.swt.widgets.Listener;
import org.codesearch.org.eclipse.swt.widgets.Sash;
import org.codesearch.org.eclipse.swt.widgets.Shell;
import org.codesearch.org.eclipse.swt.widgets.Tree;
...
public class PreferenceDialog extends TrayDialog implements IPreferencePageContainer, IPageChangeProvider {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.dialogs.Dialog#buttonPressed(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.dialogs.Dialog#cancelPressed()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.window.Window#close()
	 */
	public boolean close() {
		...
		SafeRunnable runnable = new SafeRunnable(){
			/* (non-Javadoc)
			 * @see org.codesearch.org.eclipse.core.runtime.ISafeRunnable#run()
			 */
			...
			/* (non-Javadoc)
			 * @see org.codesearch.org.eclipse.jface.util.SafeRunnable#handleException(java.lang.Throwable)
			 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.window.Window#configureShell(org.codesearch.org.eclipse.swt.widgets.Shell)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.window.Window#constrainShellSize()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.dialogs.Dialog#createButtonsForButtonBar(org.codesearch.org.eclipse.swt.widgets.Composite)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.window.Window#createContents(org.codesearch.org.eclipse.swt.widgets.Composite)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.dialogs.Dialog#createDialogArea(org.codesearch.org.eclipse.swt.widgets.Composite)
	 */
	...
	protected Sash createSash(final Composite composite, final Control rightControl) {
		...
		sash.addListener(SWT.Selection, new Listener() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.codesearch.org.eclipse.swt.widgets.Listener#handleEvent(org.codesearch.org.eclipse.swt.widgets.Event)
			 */
	...
	protected Composite createTitleArea(Composite parent) {
		...
		titleArea.addControlListener(new ControlAdapter() {
			/* (non-Javadoc)
			 * @see org.codesearch.org.eclipse.swt.events.ControlAdapter#controlResized(org.codesearch.org.eclipse.swt.events.ControlEvent)
			 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.preference.IPreferencePageContainer#getPreferenceStore()
	 */
	...
	protected void okPressed() {
		SafeRunnable.run(new SafeRunnable() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.codesearch.org.eclipse.core.runtime.ISafeRunnable#handleException(java.lang.Throwable)
			 */
			public void handleException(Throwable e) {
				errorOccurred = true;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.preference.IPreferencePageContainer#updateButtons()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.preference.IPreferencePageContainer#updateMessage()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.preference.IPreferencePageContainer#updateTitle()
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jface.dialogs.IPageChangeProvider#getSelectedPage()
	 * 
	 * @since 3.1
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jface.dialogs.IPageChangeProvider#addPageChangedListener(org.codesearch.org.eclipse.jface.dialogs.IPageChangedListener)
	 * @since 3.1
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jface.dialogs.IPageChangeProvider#removePageChangedListener(org.codesearch.org.eclipse.jface.dialogs.IPageChangedListener)
	 * @since 3.1
	 */
    ...
    /*
     * (non-Javadoc)
     * @see org.codesearch.org.eclipse.jface.dialogs.Dialog#isResizable()
     */
