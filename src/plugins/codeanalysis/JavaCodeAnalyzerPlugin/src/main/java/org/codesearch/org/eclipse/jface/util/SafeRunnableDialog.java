 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jface.util;

import java.util.ArrayList;
import java.util.Collection;

import org.codesearch.org.eclipse.core.runtime.IStatus;
import org.codesearch.org.eclipse.jface.dialogs.ErrorDialog;
...
import org.codesearch.org.eclipse.jface.viewers.CellLabelProvider;
...
import org.codesearch.org.eclipse.jface.viewers.IStructuredContentProvider;
...
import org.codesearch.org.eclipse.jface.viewers.TableViewer;
import org.codesearch.org.eclipse.jface.viewers.Viewer;
import org.codesearch.org.eclipse.jface.viewers.ViewerCell;
...
class SafeRunnableDialog extends ErrorDialog {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.dialogs.ErrorDialog#createDialogArea(org.codesearch.org.eclipse.swt.widgets.Composite)
	 */
	...
	private CellLabelProvider getStatusListLabelProvider() {
		return new CellLabelProvider() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.codesearch.org.eclipse.jface.viewers.CellLabelProvider#update(org.codesearch.org.eclipse.jface.viewers.ViewerCell)
			 */
	...
	private IStructuredContentProvider getStatusContentProvider() {
		return new IStructuredContentProvider() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.codesearch.org.eclipse.jface.viewers.IStructuredContentProvider#getElements(java.lang.Object)
			 */
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.codesearch.org.eclipse.jface.viewers.IContentProvider#dispose()
			 */
			public void dispose() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.codesearch.org.eclipse.jface.viewers.IContentProvider#inputChanged(org.codesearch.org.eclipse.jface.viewers.Viewer,
	...
	private ViewerComparator getViewerComparator() {
		return new ViewerComparator() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.codesearch.org.eclipse.jface.viewers.ViewerComparator#compare(org.codesearch.org.eclipse.jface.viewers.Viewer,
			 *      java.lang.Object, java.lang.Object)
			 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.codesearch.org.eclipse.jface.dialogs.ErrorDialog#shouldShowDetailsButton()
	 */
