...
import org.codesearch.org.eclipse.jdt.internal.core.ClasspathAccessRule;
...
void removePackage(IResourceDelta sourceDelta) {
	...
	switch(resource.getType()) {
		...
		case IResource.FILE :
			...
			if (org.codesearch.org.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(typeLocatorPath.lastSegment()))
