 ...
 *******************************************************************************/
package org.codesearch.org.eclipse.jdt.internal.core.hierarchy;
...
import org.codesearch.org.eclipse.core.runtime.NullProgressMonitor;
...
import org.codesearch.org.eclipse.jdt.internal.core.search.IndexQueryRequestor;
import org.codesearch.org.eclipse.jdt.internal.core.search.JavaSearchParticipant;
import org.codesearch.org.eclipse.jdt.internal.core.search.SubTypeSearchJob;
import org.codesearch.org.eclipse.jdt.internal.core.search.indexing.IIndexConstants;
...
import org.codesearch.org.eclipse.jdt.internal.core.search.matching.SuperTypeReferencePattern;
...
private void buildForProject(JavaProject project, ArrayList potentialSubtypes, org.codesearch.org.eclipse.jdt.core.ICompilationUnit[] workingCopies, HashSet localTypes, IProgressMonitor monitor) throws JavaModelException {
	// resolve
	...
	if (openablesLength > 0) {
		...
		org.codesearch.org.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside = null;
		if (inProjectOfFocusType) {
			org.codesearch.org.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType.getCompilationUnit();
			if (unitToLookInside != null) {
				int wcLength = workingCopies == null ? 0 : workingCopies.length;
				if (wcLength == 0) {
					unitsToLookInside = new org.codesearch.org.eclipse.jdt.core.ICompilationUnit[] {unitToLookInside};
				} else {
					unitsToLookInside = new org.codesearch.org.eclipse.jdt.core.ICompilationUnit[wcLength+1];
...
private void buildFromPotentialSubtypes(String[] allPotentialSubTypes, HashSet localTypes, IProgressMonitor monitor) {
	...
	int wcLength;
	org.codesearch.org.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.hierarchy.workingCopies;
	if (workingCopies != null && (wcLength = workingCopies.length) > 0) {
		String[] newPaths = new String[wcLength];
		for (int i = 0; i < wcLength; i++) {
			org.codesearch.org.eclipse.jdt.core.ICompilationUnit workingCopy = workingCopies[i];
	...
	try {
		...
		for (int i = 0; i < length; i++) {
			try {
				...
				Openable handle;
				org.codesearch.org.eclipse.jdt.core.ICompilationUnit workingCopy = (org.codesearch.org.eclipse.jdt.core.ICompilationUnit)wcPaths.get(resourcePath);
				if (workingCopy != null) {
