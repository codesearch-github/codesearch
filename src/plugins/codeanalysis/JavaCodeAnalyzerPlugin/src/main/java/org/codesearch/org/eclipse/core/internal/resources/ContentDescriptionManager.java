...
import org.codesearch.org.eclipse.core.internal.events.ILifecycleListener;
...
import org.codesearch.org.eclipse.core.runtime.content.*;
...
public class ContentDescriptionManager implements IManager, IRegistryChangeListener, IContentTypeManager.IContentTypeChangeListener, ILifecycleListener {
	...
	Workspace workspace;
	protected final Bundle systemBundle = Platform.getBundle("org.codesearch.org.eclipse.osgi"); //$NON-NLS-1$
