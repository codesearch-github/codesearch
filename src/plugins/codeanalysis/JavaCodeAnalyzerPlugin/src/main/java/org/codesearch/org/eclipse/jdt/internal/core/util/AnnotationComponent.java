...
public class AnnotationComponent extends ClassFileStruct implements IAnnotationComponent {
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IAnnotationComponent#getComponentNameIndex()
	 */
	public int getComponentNameIndex() {
		return this.componentNameIndex;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IAnnotationComponent#getComponentName()
	 */
	public char[] getComponentName() {
		return this.componentName;
	}
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.util.IAnnotationComponent#getComponentValue()
	 */
