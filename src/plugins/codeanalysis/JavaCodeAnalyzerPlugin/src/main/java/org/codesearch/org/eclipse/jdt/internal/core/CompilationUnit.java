...
import org.codesearch.org.eclipse.jdt.core.IPackageDeclaration;
import org.codesearch.org.eclipse.jdt.core.IJavaModelStatusConstants;
import org.codesearch.org.eclipse.jdt.core.CompletionRequestor;
import org.codesearch.org.eclipse.jdt.core.JavaCore;
import org.codesearch.org.eclipse.jdt.core.ITypeRoot;
import org.codesearch.org.eclipse.jdt.core.ICompletionRequestor;
import org.codesearch.org.eclipse.jdt.core.ICompilationUnit;
import org.codesearch.org.eclipse.jdt.core.IMember;
import org.codesearch.org.eclipse.jdt.core.IBufferFactory;
...
import org.codesearch.org.eclipse.jdt.core.ICodeCompletionRequestor;
import org.codesearch.org.eclipse.jdt.core.IPackageFragment;
import org.codesearch.org.eclipse.jdt.core.IBuffer;
...
import org.codesearch.org.eclipse.jdt.core.IImportContainer;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.SourceElementParser;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.problem.AbortCompilationUnit;
...
import org.codesearch.org.eclipse.text.edits.UndoEdit;

/**
 * @see ICompilationUnit
 */
public class CompilationUnit extends Openable implements ICompilationUnit, org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit, SuffixConstants {
	/**
...
protected boolean buildStructure(OpenableElementInfo info, final IProgressMonitor pm, Map newElements, IResource underlyingResource) throws JavaModelException {
	...
	try {
		...
		if (createAST) {
			...
			org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit cu = AST.convertCompilationUnit(astLevel, compilationUnitDeclaration, options, computeProblems, source, reconcileFlags, pm);
...
public void codeComplete(int offset, ICompletionRequestor requestor, WorkingCopyOwner workingCopyOwner) throws JavaModelException {
	...
	codeComplete(offset, new org.codesearch.org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), workingCopyOwner);
}
/**
...
/* (non-Javadoc)
 * @see org.codesearch.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, org.codesearch.org.eclipse.jdt.core.CompletionRequestor)
 */
public void codeComplete(int offset, CompletionRequestor requestor) throws JavaModelException {
	codeComplete(offset, requestor, DefaultWorkingCopyOwner.PRIMARY);
}
/* (non-Javadoc)
 * @see org.codesearch.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, org.codesearch.org.eclipse.jdt.core.CompletionRequestor, org.codesearch.org.eclipse.core.runtime.IProgressMonitor)
 */
...
/* (non-Javadoc)
 * @see org.codesearch.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, org.codesearch.org.eclipse.jdt.core.CompletionRequestor, org.codesearch.org.eclipse.jdt.core.WorkingCopyOwner)
 */
...
/* (non-Javadoc)
 * @see org.codesearch.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, org.codesearch.org.eclipse.jdt.core.CompletionRequestor, org.codesearch.org.eclipse.jdt.core.WorkingCopyOwner, org.codesearch.org.eclipse.core.runtime.IProgressMonitor)
 */
public void codeComplete(int offset, CompletionRequestor requestor, WorkingCopyOwner workingCopyOwner, IProgressMonitor monitor) throws JavaModelException {
	codeComplete(
			this,
			isWorkingCopy() ? (org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) getOriginalElement() : this,
			offset,
			requestor,
			workingCopyOwner,
			this,
...
/**
 * @see org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit#getContents()
 */
public char[] getContents() {
...
/**
 * @see org.codesearch.org.eclipse.jdt.internal.compiler.env.IDependent#getFileName()
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit#getMainTypeName()
 */
...
/**
 * @see org.codesearch.org.eclipse.jdt.internal.compiler.env.ICompilationUnit#getPackageName()
 */
...
public org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit makeConsistent(int astLevel, boolean resolveBindings, int reconcileFlags, HashMap problems, IProgressMonitor monitor) throws JavaModelException {
	...
	try {
		...
		if (astLevel != NO_AST || problems != null) {
			...
			org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit result = info.ast;
			info.ast = null;
			return result;
		} else {
 ...
 * @since 3.0
 */
public org.codesearch.org.eclipse.jdt.core.dom.CompilationUnit reconcile(
		int astLevel,
