...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.BaseTypeBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Binding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.CaptureBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.FieldBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding;
import org.codesearch.org.eclipse.jdt.internal.compiler.lookup.RawTypeBinding;
...
import org.codesearch.org.eclipse.jdt.internal.compiler.util.SuffixConstants;
import org.codesearch.org.eclipse.jdt.internal.core.JavaElement;
import org.codesearch.org.eclipse.jdt.internal.core.PackageFragment;

/**
 * Internal implementation of type bindings.
 */
class TypeBinding implements ITypeBinding {
	private static final StringLiteral EXPRESSION = new org.codesearch.org.eclipse.jdt.internal.compiler.ast.StringLiteral(0,0);
	...
	org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding;
	private String key;
	...
	public TypeBinding(BindingResolver resolver, org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding) {
	...
	public IAnnotationBinding[] getAnnotations() {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding refType = null;
		if (this.binding instanceof ParameterizedTypeBinding) {
			...
			refType = (org.codesearch.org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding) this.binding;
		}
		if (refType != null) {
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations = refType.getAnnotations();
			int length = internalAnnotations == null ? 0 : internalAnnotations.length;
			if (length != 0) {
				IAnnotationBinding[] tempAnnotations = new IAnnotationBinding[length];
				int convertedAnnotationCount = 0;
				for (int i = 0; i < length; i++) {
					org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalAnnotation = internalAnnotations[i];
	...
	public String getBinaryName() {
		if (this.binding.isCapture()) {
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Binding declaring = typeVariableBinding.declaringElement;
			StringBuffer binaryName = new StringBuffer();
			switch(declaring.kind()) {
				case org.codesearch.org.eclipse.jdt.internal.compiler.lookup.Binding.METHOD :
					...
					break;
				default :
					org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaring;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getBound()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getGenericTypeOfWildcardType()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getRank()
	 */
	public int getRank() {
		switch (this.binding.kind()) {
			case Binding.WILDCARD_TYPE :
	...
	public synchronized IVariableBinding[] getDeclaredFields() {
		...
		try {
			 ...
			 */
			org.codesearch.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared fields"); //$NON-NLS-1$
		}
		return this.fields = NO_VARIABLE_BINDINGS;
	}
	...
	public synchronized IMethodBinding[] getDeclaredMethods() {
		...
		try {
			if (isClass() || isInterface() || isEnum()) {
				ReferenceBinding referenceBinding = (ReferenceBinding) this.binding;
				org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding[] internalMethods = referenceBinding.availableMethods(); // be resilient
				int length = internalMethods.length;
				if (length != 0) {
					int convertedMethodCount = 0;
					IMethodBinding[] newMethods = new IMethodBinding[length];
					for (int i = 0; i < length; i++) {
						org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding = internalMethods[i];
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			org.codesearch.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared methods"); //$NON-NLS-1$
		}
		return this.methods = NO_METHOD_BINDINGS;
	}
		...
		if (this.binding instanceof LocalTypeBinding) {
			...
			if (methodBinding != null) {
				try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
					org.codesearch.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring method"); //$NON-NLS-1$
				}
			}
		} else if (this.binding.isTypeVariable()) {
			TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
		...
		if (isClass() || isInterface() || isEnum()) {
			...
			if (referenceBinding.isNestedType()) {
				try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
					org.codesearch.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring class"); //$NON-NLS-1$
				}
			}
		} else if (this.binding.isTypeVariable()) {
			TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getTypeDeclaration()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getErasure()
	 */
	...
	public synchronized ITypeBinding[] getInterfaces() {
		...
		try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			org.codesearch.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve interfaces"); //$NON-NLS-1$
		}
	...
	private JavaElement getUnresolvedJavaElement(org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding ) {
		...
		if (this.resolver instanceof DefaultBindingResolver) {
			...
			return org.codesearch.org.eclipse.jdt.internal.core.util.Util.getUnresolvedJavaElement(
					typeBinding,
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getQualifiedName()
	 */
	...
	public synchronized ITypeBinding getSuperclass() {
		...
		try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			org.codesearch.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve superclass"); //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getTypeArguments()
	 */
	public ITypeBinding[] getTypeArguments() {
		...
		if (this.binding.isParameterizedTypeWithActualArguments()) {
			ParameterizedTypeBinding parameterizedTypeBinding = (ParameterizedTypeBinding) this.binding;
			final org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] arguments = parameterizedTypeBinding.arguments;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getTypeBounds()
	 */
	public ITypeBinding[] getTypeBounds() {
		...
		if (this.binding instanceof TypeVariableBinding) {
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding firstClassOrArrayBound = typeVariableBinding.firstBound;
			int boundsLength = 0;
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getTypeParameters()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#getWildcard()
	 * @since 3.1
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#isGenericType()
	 * @since 3.1
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#isAnnotation()
	 */
	...
	public boolean isCastCompatible(ITypeBinding type) {
		try {
			...
			if (scope == null) return false;
			if (!(type instanceof TypeBinding)) return false;
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding expressionType = ((TypeBinding) type).binding;
	...
	public boolean isEqualTo(IBinding other) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding otherBinding = ((TypeBinding) other).binding;
		// check return type
	...
	public boolean isFromSource() {
		if (isClass() || isInterface() || isEnum()) {
			...
			if (referenceBinding.isRawType()) {
				...
				org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding erasure = parameterizedTypeBinding.erasure();
			...
			if (declaringElement instanceof MethodBinding) {
				...
				final org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaringElement;
				if (typeBinding instanceof ReferenceBinding) {
					...
					final org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding leafComponentType = arrayBinding.leafComponentType;
	...
	public boolean isNullType() {
		return this.binding == org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.NULL;
	}

	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#isParameterizedType()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#isRawType()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#isUpperbound()
	 */
	...
	/* (non-Javadoc)
	 * @see org.codesearch.org.eclipse.jdt.core.dom.ITypeBinding#isWildcardType()
	 */
