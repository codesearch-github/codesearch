...
class MethodBinding implements IMethodBinding {
	...
	private org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding binding;
	...
	MethodBinding(BindingResolver resolver, org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding binding) {
	...
	public IAnnotationBinding[] getAnnotations() {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations = this.binding.getAnnotations();
	...
	public IAnnotationBinding[] getParameterAnnotations(int index) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations = this.binding.getParameterAnnotations();
		...
		for (int i = 0; i < length; i++) {
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations = bindingAnnotations[i];
	...
	public ITypeBinding[] getParameterTypes() {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] parameters = this.binding.parameters;
	...
	public ITypeBinding[] getExceptionTypes() {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] exceptions = this.binding.thrownExceptions;
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.IMethodBinding#isVarargs()
	 * @since 3.1
	 */
	...
	public boolean isEqualTo(IBinding other) {
		...
		org.codesearch.org.eclipse.jdt.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding) other).binding;
		return BindingComparator.isEqual(this.binding, otherBinding);
	}

	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.IMethodBinding#getTypeParameters()
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.IMethodBinding#isGenericMethod()
	 * @since 3.1
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.IMethodBinding#getTypeArguments()
	 */
	public ITypeBinding[] getTypeArguments() {
		...
		if (this.binding instanceof ParameterizedGenericMethodBinding) {
			...
			org.codesearch.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings = genericMethodBinding.typeArguments;
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.IMethodBinding#isParameterizedMethod()
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.IMethodBinding#isRawMethod()
	 */
	...
	/**
	 * @see org.codesearch.org.eclipse.jdt.core.dom.IMethodBinding#getMethodDeclaration()
	 */
