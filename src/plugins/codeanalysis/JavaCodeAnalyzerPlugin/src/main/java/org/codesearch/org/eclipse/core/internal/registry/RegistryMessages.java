...
public class RegistryMessages extends NLS {
	 ...
	 */
	public static final String OWNER_NAME = "org.codesearch.org.eclipse.equinox.registry"; //$NON-NLS-1$

	private static final String BUNDLE_NAME = "org.codesearch.org.eclipse.core.internal.registry.messages"; //$NON-NLS-1$
